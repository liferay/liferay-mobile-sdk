...
#import "LRUserService_v72.h"

/**
 * @author Bruno Farache
 */
@implementation LRUserService_v72
...
- (NSArray *)getGroupUsersWithGroupId:(long long)groupId status:(int)status obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"obc" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.model.User>" wrapper:obc];
