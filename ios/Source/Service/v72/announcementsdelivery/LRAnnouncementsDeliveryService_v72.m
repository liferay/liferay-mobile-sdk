...
#import "LRAnnouncementsDeliveryService_v72.h"

/**
 * @author Bruno Farache
 */
@implementation LRAnnouncementsDeliveryService_v72

- (NSDictionary *)updateDeliveryWithUserId:(long long)userId type:(NSString *)type email:(BOOL)email sms:(BOOL)sms error:(NSError **)error {
