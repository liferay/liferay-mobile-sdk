...
#import "LRJournalFolderService_v72.h"

/**
 * @author Bruno Farache
 */
@implementation LRJournalFolderService_v72
...
- (NSArray *)getFoldersAndArticlesWithGroupId:(long long)groupId userId:(long long)userId folderId:(long long)folderId status:(int)status locale:(NSString *)locale start:(int)start end:(int)end obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"groupId": @(groupId),
		@"userId": @(userId),
		@"folderId": @(folderId),
...
- (NSArray *)searchDdmStructuresWithCompanyId:(long long)companyId groupIds:(NSArray *)groupIds folderId:(long long)folderId restrictionType:(int)restrictionType keywords:(NSString *)keywords start:(int)start end:(int)end obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"companyId": @(companyId),
	...
	[self mangleWrapperWithParams:_params name:@"obc" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.mapping.model.DDMStructure>" wrapper:obc];
