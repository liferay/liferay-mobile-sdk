...
#import "LRTrashEntryService_v72.h"

/**
 * @author Bruno Farache
 */
@implementation LRTrashEntryService_v72
...
- (NSDictionary *)getEntriesWithGroupId:(long long)groupId start:(int)start end:(int)end obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"obc" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.trash.model.TrashEntry>" wrapper:obc];
...
- (NSDictionary *)getEntriesWithGroupId:(long long)groupId className:(NSString *)className start:(int)start end:(int)end obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"groupId": @(groupId),
		@"className": [self checkNull: className],
		@"start": @(start),
