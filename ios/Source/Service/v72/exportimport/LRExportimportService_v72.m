...
#import "LRExportimportService_v72.h"

/**
 * @author Bruno Farache
 */
@implementation LRExportimportService_v72
...
- (void)importLayoutsWithUserId:(long long)userId groupId:(long long)groupId privateLayout:(BOOL)privateLayout parameterMap:(NSDictionary *)parameterMap file:(LRUploadData *)file error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"userId": @(userId),
		@"groupId": @(groupId),
		@"privateLayout": @(privateLayout),
