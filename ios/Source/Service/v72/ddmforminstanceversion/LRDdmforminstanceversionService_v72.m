...
#import "LRDdmforminstanceversionService_v72.h"

/**
 * @author Bruno Farache
 */
@implementation LRDdmforminstanceversionService_v72
...
- (NSDictionary *)getLatestFormInstanceVersionWithDdmFormInstanceId:(long long)ddmFormInstanceId status:(int)status error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"ddmFormInstanceId": @(ddmFormInstanceId),
		@"status": @(status)
	}];
