...
#import "LRDdmforminstancerecordversionService_v72.h"

/**
 * @author Bruno Farache
 */
@implementation LRDdmforminstancerecordversionService_v72
...
- (NSDictionary *)fetchLatestFormInstanceRecordVersionWithUserId:(long long)userId formInstanceId:(long long)formInstanceId formInstanceVersion:(NSString *)formInstanceVersion status:(int)status error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"userId": @(userId),
		@"formInstanceId": @(formInstanceId),
		@"formInstanceVersion": [self checkNull: formInstanceVersion],
		@"status": @(status)
	}];

	NSDictionary *_command = @{@"/ddm.ddmforminstancerecordversion/fetch-latest-form-instance-record-version": _params};
