...
#import "LRBlogsEntryService_v72.h"

/**
 * @author Bruno Farache
 */
@implementation LRBlogsEntryService_v72
...
- (NSArray *)getGroupUserEntriesWithGroupId:(long long)groupId userId:(long long)userId statuses:(NSArray *)statuses start:(int)start end:(int)end obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"obc" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.blogs.model.BlogsEntry>" wrapper:obc];
