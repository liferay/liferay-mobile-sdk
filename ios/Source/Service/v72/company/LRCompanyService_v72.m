...
#import "LRCompanyService_v72.h"

/**
 * @author Bruno Farache
 */
@implementation LRCompanyService_v72
...
- (void)updatePreferencesWithCompanyId:(long long)companyId properties:(NSDictionary *)properties error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"companyId": @(companyId),
