...
#import "LRPasswordPolicyService_v72.h"

/**
 * @author Bruno Farache
 */
@implementation LRPasswordPolicyService_v72
...
- (NSArray *)searchWithCompanyId:(long long)companyId name:(NSString *)name start:(int)start end:(int)end obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"obc" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.model.PasswordPolicy>" wrapper:obc];
