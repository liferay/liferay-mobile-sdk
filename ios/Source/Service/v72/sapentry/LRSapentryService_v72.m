...
#import "LRSapentryService_v72.h"

/**
 * @author Bruno Farache
 */
@implementation LRSapentryService_v72
...
- (NSArray *)getCompanySapEntriesWithCompanyId:(long long)companyId start:(int)start end:(int)end obc:(LRJSONObjectWrapper *)obc error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"obc" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.security.service.access.policy.model.SAPEntry>" wrapper:obc];
