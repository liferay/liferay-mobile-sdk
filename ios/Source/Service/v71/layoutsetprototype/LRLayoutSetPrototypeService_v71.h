 ...
 */
@interface LRLayoutSetPrototypeService_v71 : LRBaseService
...
- (void)deleteLayoutSetPrototypeWithLayoutSetPrototypeId:(long long)layoutSetPrototypeId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
