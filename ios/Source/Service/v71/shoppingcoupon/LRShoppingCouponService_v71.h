 ...
 */
@interface LRShoppingCouponService_v71 : LRBaseService
...
- (void)deleteCouponWithGroupId:(long long)groupId couponId:(long long)couponId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
