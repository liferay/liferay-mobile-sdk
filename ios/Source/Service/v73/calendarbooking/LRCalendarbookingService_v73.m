...
#import "LRCalendarbookingService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRCalendarbookingService_v73
...
- (NSArray *)getChildCalendarBookingsWithParentCalendarBookingId:(long long)parentCalendarBookingId includeStagingCalendarBookings:(BOOL)includeStagingCalendarBookings error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"parentCalendarBookingId": @(parentCalendarBookingId),
		@"includeStagingCalendarBookings": @(includeStagingCalendarBookings)
	}];
...
- (void)deleteCalendarBookingInstanceWithCalendarBookingId:(long long)calendarBookingId instanceIndex:(int)instanceIndex allFollowing:(BOOL)allFollowing deleteRecurringCalendarBookings:(BOOL)deleteRecurringCalendarBookings error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"calendarBookingId": @(calendarBookingId),
		@"instanceIndex": @(instanceIndex),
		@"allFollowing": @(allFollowing),
		@"deleteRecurringCalendarBookings": @(deleteRecurringCalendarBookings)
	}];
...
- (NSDictionary *)getLastInstanceCalendarBookingWithCalendarBookingId:(long long)calendarBookingId error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"calendarBookingId": @(calendarBookingId)
	}];

	NSDictionary *_command = @{@"/calendar.calendarbooking/get-last-instance-calendar-booking": _params};
...
- (NSDictionary *)invokeTransitionWithCalendarBookingId:(long long)calendarBookingId instanceIndex:(int)instanceIndex status:(int)status updateInstance:(BOOL)updateInstance allFollowing:(BOOL)allFollowing serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"calendarBookingId": @(calendarBookingId),
		@"instanceIndex": @(instanceIndex),
		@"status": @(status),
...
- (NSDictionary *)invokeTransitionWithCalendarBookingId:(long long)calendarBookingId startTime:(long long)startTime status:(int)status updateInstance:(BOOL)updateInstance allFollowing:(BOOL)allFollowing serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"calendarBookingId": @(calendarBookingId),
		@"startTime": @(startTime),
		@"status": @(status),
...
- (NSDictionary *)updateCalendarBookingInstanceWithCalendarBookingId:(long long)calendarBookingId instanceIndex:(int)instanceIndex calendarId:(long long)calendarId childCalendarIds:(NSArray *)childCalendarIds titleMap:(NSDictionary *)titleMap descriptionMap:(NSDictionary *)descriptionMap location:(NSString *)location startTime:(long long)startTime endTime:(long long)endTime allDay:(BOOL)allDay allFollowing:(BOOL)allFollowing firstReminder:(long long)firstReminder firstReminderType:(NSString *)firstReminderType secondReminder:(long long)secondReminder secondReminderType:(NSString *)secondReminderType serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"calendarBookingId": @(calendarBookingId),
		@"instanceIndex": @(instanceIndex),
		@"calendarId": @(calendarId),
...
- (void)updateLastInstanceCalendarBookingRecurrenceWithCalendarBookingId:(long long)calendarBookingId recurrence:(NSString *)recurrence error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"calendarBookingId": @(calendarBookingId),
		@"recurrence": [self checkNull: recurrence]
	}];

	NSDictionary *_command = @{@"/calendar.calendarbooking/update-last-instance-calendar-booking-recurrence": _params};
...
- (NSDictionary *)updateRecurringCalendarBookingWithCalendarBookingId:(long long)calendarBookingId calendarId:(long long)calendarId childCalendarIds:(NSArray *)childCalendarIds titleMap:(NSDictionary *)titleMap descriptionMap:(NSDictionary *)descriptionMap location:(NSString *)location startTime:(long long)startTime endTime:(long long)endTime allDay:(BOOL)allDay firstReminder:(long long)firstReminder firstReminderType:(NSString *)firstReminderType secondReminder:(long long)secondReminder secondReminderType:(NSString *)secondReminderType serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"calendarBookingId": @(calendarBookingId),
		@"calendarId": @(calendarId),
		@"childCalendarIds": [self checkNull: childCalendarIds],
	...
	NSDictionary *_command = @{@"/calendar.calendarbooking/update-recurring-calendar-booking": _params};
