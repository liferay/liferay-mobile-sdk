 ...
 */
@interface LRCommerceinventoryreplenishmentitemService_v73 : LRBaseService
...
- (void)deleteCommerceInventoryReplenishmentItemWithCommerceInventoryReplenishmentItemId:(long long)commerceInventoryReplenishmentItemId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
