...
#import "LRDLAppService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRDLAppService_v73
...
- (NSArray *)getFileEntriesWithRepositoryId:(long long)repositoryId folderId:(long long)folderId fileEntryTypeId:(long long)fileEntryTypeId start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"orderByComparator" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.repository.model.FileEntry>" wrapper:orderByComparator];
...
- (void)deleteFileVersionWithFileVersionId:(long long)fileVersionId error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
...
- (NSDictionary *)updateFileEntryWithFileEntryId:(long long)fileEntryId sourceFileName:(NSString *)sourceFileName mimeType:(NSString *)mimeType title:(NSString *)title description:(NSString *)description changeLog:(NSString *)changeLog dlVersionNumberIncrease:(LRJSONObjectWrapper *)dlVersionNumberIncrease bytes:(NSData *)bytes serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"dlVersionNumberIncrease" className:@"com.liferay.document.library.kernel.model.DLVersionNumberIncrease" wrapper:dlVersionNumberIncrease];
	[self mangleWrapperWithParams:_params name:@"serviceContext" className:@"com.liferay.portal.kernel.service.ServiceContext" wrapper:serviceContext];
...
- (void)checkInFileEntryWithFileEntryId:(long long)fileEntryId dlVersionNumberIncrease:(LRJSONObjectWrapper *)dlVersionNumberIncrease changeLog:(NSString *)changeLog serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"fileEntryId": @(fileEntryId),
		@"changeLog": [self checkNull: changeLog],
	}];
...
- (NSArray *)getFoldersWithRepositoryId:(long long)repositoryId parentFolderId:(long long)parentFolderId includeMountFolders:(BOOL)includeMountFolders start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"orderByComparator" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.repository.model.Folder>" wrapper:orderByComparator];
