 ...
 */
@interface LROauthapplicationService_v73 : LRBaseService

- (void)deleteLogoWithOAuthApplicationId:(long long)oAuthApplicationId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
