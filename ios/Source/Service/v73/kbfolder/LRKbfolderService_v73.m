...
#import "LRKbfolderService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRKbfolderService_v73
...
- (NSDictionary *)fetchFirstChildKbFolderWithGroupId:(long long)groupId kbFolderId:(long long)kbFolderId orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"orderByComparator" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.knowledge.base.model.KBFolder>" wrapper:orderByComparator];
