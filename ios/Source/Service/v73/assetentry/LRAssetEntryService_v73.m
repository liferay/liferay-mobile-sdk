...
#import "LRAssetEntryService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRAssetEntryService_v73
...
- (NSDictionary *)incrementViewCounterWithCompanyId:(long long)companyId className:(NSString *)className classPK:(long long)classPK error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"companyId": @(companyId),
		@"className": [self checkNull: className],
		@"classPK": @(classPK)
...
- (void)incrementViewCounterWithAssetEntry:(LRJSONObjectWrapper *)assetEntry error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
	}];

	[self mangleWrapperWithParams:_params name:@"assetEntry" className:@"com.liferay.asset.kernel.model.AssetEntry" wrapper:assetEntry];
...
- (NSDictionary *)getEntryWithClassName:(NSString *)className classPK:(long long)classPK error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"className": [self checkNull: className],
		@"classPK": @(classPK)
	}];
