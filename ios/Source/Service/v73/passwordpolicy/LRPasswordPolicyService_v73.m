...
#import "LRPasswordPolicyService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRPasswordPolicyService_v73
...
- (NSNumber *)searchCountWithCompanyId:(long long)companyId name:(NSString *)name error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/passwordpolicy/search-count": _params};
...
- (NSArray *)searchWithCompanyId:(long long)companyId name:(NSString *)name start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"companyId": @(companyId),
		@"name": [self checkNull: name],
		@"start": @(start),
	...
	[self mangleWrapperWithParams:_params name:@"orderByComparator" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.model.PasswordPolicy>" wrapper:orderByComparator];

	NSDictionary *_command = @{@"/passwordpolicy/search": _params};
