 ...
 */
@interface LRJournalFolderService_v73 : LRBaseService

- (NSDictionary *)getFolderWithFolderId:(long long)folderId error:(NSError **)error;
- (NSArray *)getDdmStructuresWithGroupIds:(NSArray *)groupIds folderId:(long long)folderId restrictionType:(int)restrictionType orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error;
...
- (void)unsubscribeWithGroupId:(long long)groupId folderId:(long long)folderId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
- (void)subscribeWithGroupId:(long long)groupId folderId:(long long)folderId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
...
- (NSArray *)getFoldersAndArticlesWithGroupId:(long long)groupId userId:(long long)userId folderId:(long long)folderId status:(int)status start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error;
- (NSArray *)getFoldersAndArticlesWithGroupId:(long long)groupId folderId:(long long)folderId start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error;
- (NSArray *)getFoldersAndArticlesWithGroupId:(long long)groupId folderId:(long long)folderId status:(int)status start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error;
- (NSArray *)getFoldersAndArticlesWithGroupId:(long long)groupId userId:(long long)userId folderId:(long long)folderId status:(int)status locale:(NSString *)locale start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error;
- (NSArray *)searchDdmStructuresWithCompanyId:(long long)companyId groupIds:(NSArray *)groupIds folderId:(long long)folderId restrictionType:(int)restrictionType keywords:(NSString *)keywords start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error;
