 ...
 */
@interface LRCompanyService_v73 : LRBaseService
...
- (void)updatePreferencesWithCompanyId:(long long)companyId unicodeProperties:(NSDictionary *)unicodeProperties error:(NSError **)error CONVERT_ERROR_TO_THROWS;
