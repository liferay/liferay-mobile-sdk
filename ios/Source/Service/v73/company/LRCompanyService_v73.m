...
#import "LRCompanyService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRCompanyService_v73
...
- (NSArray *)getCompanies:(NSError **)error {
	...
	NSDictionary *_command = @{@"/company/get-companies": _params};
...
- (void)removePreferencesWithCompanyId:(long long)companyId keys:(NSArray *)keys error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"companyId": @(companyId),
		@"keys": [self checkNull: keys]
	}];

	NSDictionary *_command = @{@"/company/remove-preferences": _params};
...
- (void)updatePreferencesWithCompanyId:(long long)companyId unicodeProperties:(NSDictionary *)unicodeProperties error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"companyId": @(companyId),
		@"unicodeProperties": [self checkNull: unicodeProperties]
	}];

	NSDictionary *_command = @{@"/company/update-preferences": _params};
