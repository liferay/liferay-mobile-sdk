...
#import "LRDdmforminstanceService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRDdmforminstanceService_v73

- (void)sendEmailWithFormInstanceId:(long long)formInstanceId message:(NSString *)message subject:(NSString *)subject toEmailAddresses:(NSArray *)toEmailAddresses error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"formInstanceId": @(formInstanceId),
		@"message": [self checkNull: message],
		@"subject": [self checkNull: subject],
		@"toEmailAddresses": [self checkNull: toEmailAddresses]
	}];

	NSDictionary *_command = @{@"/ddm.ddmforminstance/send-email": _params};
...
- (NSDictionary *)copyFormInstanceWithGroupId:(long long)groupId nameMap:(NSDictionary *)nameMap ddmFormInstance:(LRJSONObjectWrapper *)ddmFormInstance settingsDDMFormValues:(LRJSONObjectWrapper *)settingsDDMFormValues serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"ddmFormInstance" className:@"com.liferay.dynamic.data.mapping.model.DDMFormInstance" wrapper:ddmFormInstance];
	[self mangleWrapperWithParams:_params name:@"settingsDDMFormValues" className:@"com.liferay.dynamic.data.mapping.storage.DDMFormValues" wrapper:settingsDDMFormValues];
	[self mangleWrapperWithParams:_params name:@"serviceContext" className:@"com.liferay.portal.kernel.service.ServiceContext" wrapper:serviceContext];

	NSDictionary *_command = @{@"/ddm.ddmforminstance/copy-form-instance": _params};
