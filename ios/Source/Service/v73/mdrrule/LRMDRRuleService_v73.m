...
#import "LRMDRRuleService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRMDRRuleService_v73
...
- (NSDictionary *)updateRuleWithRuleId:(long long)ruleId nameMap:(NSDictionary *)nameMap descriptionMap:(NSDictionary *)descriptionMap type:(NSString *)type typeSettingsUnicodeProperties:(NSDictionary *)typeSettingsUnicodeProperties serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"ruleId": @(ruleId),
		@"nameMap": [self checkNull: nameMap],
		@"descriptionMap": [self checkNull: descriptionMap],
