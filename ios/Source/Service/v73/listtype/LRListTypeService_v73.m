...
#import "LRListTypeService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRListTypeService_v73

- (NSDictionary *)getListTypeWithName:(NSString *)name type:(NSString *)type error:(NSError **)error {
