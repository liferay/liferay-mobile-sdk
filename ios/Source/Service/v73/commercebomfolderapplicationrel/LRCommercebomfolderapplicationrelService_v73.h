 ...
 */
@interface LRCommercebomfolderapplicationrelService_v73 : LRBaseService

- (void)deleteCommerceBomFolderApplicationRelWithCommerceBOMFolderApplicationRelId:(long long)commerceBOMFolderApplicationRelId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
