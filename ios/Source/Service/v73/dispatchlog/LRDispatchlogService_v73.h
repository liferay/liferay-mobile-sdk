 ...
 */
@interface LRDispatchlogService_v73 : LRBaseService
...
- (void)deleteDispatchLogWithDispatchLogId:(long long)dispatchLogId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
