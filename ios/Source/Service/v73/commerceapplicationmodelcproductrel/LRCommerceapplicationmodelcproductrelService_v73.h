 ...
 */
@interface LRCommerceapplicationmodelcproductrelService_v73 : LRBaseService
...
- (void)deleteCommerceApplicationModelCProductRelWithCommerceApplicationModelCProductRelId:(long long)commerceApplicationModelCProductRelId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
