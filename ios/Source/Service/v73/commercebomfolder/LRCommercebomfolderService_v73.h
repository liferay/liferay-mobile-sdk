 ...
 */
@interface LRCommercebomfolderService_v73 : LRBaseService
...
- (void)deleteCommerceBomFolderWithCommerceBOMFolderId:(long long)commerceBOMFolderId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
