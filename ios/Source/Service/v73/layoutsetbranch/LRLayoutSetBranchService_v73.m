...
#import "LRLayoutSetBranchService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRLayoutSetBranchService_v73
...
- (void)deleteLayoutSetBranchWithCurrentLayoutPlid:(long long)currentLayoutPlid layoutSetBranchId:(long long)layoutSetBranchId error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"currentLayoutPlid": @(currentLayoutPlid),
		@"layoutSetBranchId": @(layoutSetBranchId)
	}];
