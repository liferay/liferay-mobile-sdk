...
#import "LRSapentryService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRSapentryService_v73
...
- (NSDictionary *)deleteSapEntryWithSapEntry:(LRJSONObjectWrapper *)sapEntry error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"sapEntry" className:@"com.liferay.portal.security.service.access.policy.model.SAPEntry" wrapper:sapEntry];
...
- (NSArray *)getCompanySapEntriesWithCompanyId:(long long)companyId start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"companyId": @(companyId),
		@"start": @(start),
		@"end": @(end),
	...
	[self mangleWrapperWithParams:_params name:@"orderByComparator" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.security.service.access.policy.model.SAPEntry>" wrapper:orderByComparator];
