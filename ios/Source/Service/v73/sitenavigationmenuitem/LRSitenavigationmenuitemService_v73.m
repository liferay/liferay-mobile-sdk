...
#import "LRSitenavigationmenuitemService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRSitenavigationmenuitemService_v73
...
- (NSArray *)getSiteNavigationMenuItemsWithSiteNavigationMenuId:(long long)siteNavigationMenuId parentSiteNavigationMenuItemId:(long long)parentSiteNavigationMenuItemId error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"siteNavigationMenuId": @(siteNavigationMenuId),
		@"parentSiteNavigationMenuItemId": @(parentSiteNavigationMenuItemId)
	}];
