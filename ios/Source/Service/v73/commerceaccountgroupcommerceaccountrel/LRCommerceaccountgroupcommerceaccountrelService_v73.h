 ...
 */
@interface LRCommerceaccountgroupcommerceaccountrelService_v73 : LRBaseService
...
- (void)deleteCommerceAccountGroupCommerceAccountRelWithCommerceAccountGroupCommerceAccountRelId:(long long)commerceAccountGroupCommerceAccountRelId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
