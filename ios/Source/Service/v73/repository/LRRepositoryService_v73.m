...
#import "LRRepositoryService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRRepositoryService_v73

- (NSDictionary *)addRepositoryWithGroupId:(long long)groupId classNameId:(long long)classNameId parentFolderId:(long long)parentFolderId name:(NSString *)name description:(NSString *)description portletId:(NSString *)portletId typeSettingsUnicodeProperties:(NSDictionary *)typeSettingsUnicodeProperties serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
...
- (NSDictionary *)getRepositoryWithGroupId:(long long)groupId portletId:(NSString *)portletId error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"groupId": @(groupId),
		@"portletId": [self checkNull: portletId]
	}];
