...
#import "LROrganizationService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LROrganizationService_v73
...
- (NSDictionary *)updateOrganizationWithOrganizationId:(long long)organizationId parentOrganizationId:(long long)parentOrganizationId name:(NSString *)name type:(NSString *)type regionId:(long long)regionId countryId:(long long)countryId statusId:(long long)statusId comments:(NSString *)comments hasLogo:(BOOL)hasLogo logoBytes:(NSData *)logoBytes site:(BOOL)site addresses:(NSArray *)addresses emailAddresses:(NSArray *)emailAddresses orgLabors:(NSArray *)orgLabors phones:(NSArray *)phones websites:(NSArray *)websites serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"organizationId": @(organizationId),
		@"parentOrganizationId": @(parentOrganizationId),
		@"name": [self checkNull: name],
...
- (NSArray *)getOrganizationsWithCompanyId:(long long)companyId parentOrganizationId:(long long)parentOrganizationId name:(NSString *)name start:(int)start end:(int)end error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"companyId": @(companyId),
		@"parentOrganizationId": @(parentOrganizationId),
		@"name": [self checkNull: name],
...
- (NSNumber *)getOrganizationsCountWithCompanyId:(long long)companyId parentOrganizationId:(long long)parentOrganizationId name:(NSString *)name error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"companyId": @(companyId),
		@"parentOrganizationId": @(parentOrganizationId),
		@"name": [self checkNull: name]
...
- (NSArray *)getGtOrganizationsWithGtOrganizationId:(long long)gtOrganizationId companyId:(long long)companyId parentOrganizationId:(long long)parentOrganizationId size:(int)size error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"gtOrganizationId": @(gtOrganizationId),
		@"companyId": @(companyId),
		@"parentOrganizationId": @(parentOrganizationId),
		@"size": @(size)
	}];

	NSDictionary *_command = @{@"/organization/get-gt-organizations": _params};
