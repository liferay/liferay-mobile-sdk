 ...
 */
@interface LRGroupService_v73 : LRBaseService
...
- (NSArray *)getUserSitesGroupsWithUserId:(long long)userId start:(int)start end:(int)end error:(NSError **)error;
...
- (void)unsetRoleGroupsWithRoleId:(long long)roleId groupIds:(NSArray *)groupIds error:(NSError **)error CONVERT_ERROR_TO_THROWS;
- (NSDictionary *)updateFriendlyUrlWithGroupId:(long long)groupId friendlyURL:(NSString *)friendlyURL error:(NSError **)error;
- (void)checkRemoteStagingGroupWithGroupId:(long long)groupId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
...
- (void)addRoleGroupsWithRoleId:(long long)roleId groupIds:(NSArray *)groupIds error:(NSError **)error CONVERT_ERROR_TO_THROWS;
- (void)setRoleGroupsWithRoleId:(long long)roleId groupIds:(NSArray *)groupIds error:(NSError **)error CONVERT_ERROR_TO_THROWS;
- (NSArray *)getGtGroupsWithGtGroupId:(long long)gtGroupId companyId:(long long)companyId parentGroupId:(long long)parentGroupId site:(BOOL)site size:(int)size error:(NSError **)error;
...
- (void)disableStagingWithGroupId:(long long)groupId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
- (void)updateStagedPortletsWithGroupId:(long long)groupId stagedPortletIds:(NSDictionary *)stagedPortletIds error:(NSError **)error CONVERT_ERROR_TO_THROWS;
- (void)deleteGroupWithGroupId:(long long)groupId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
- (void)enableStagingWithGroupId:(long long)groupId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
...
- (NSNumber *)searchCountWithCompanyId:(long long)companyId classNameIds:(NSArray *)classNameIds keywords:(NSString *)keywords params:(NSDictionary *)params error:(NSError **)error;
- (NSNumber *)getGroupsCountWithCompanyId:(long long)companyId parentGroupId:(long long)parentGroupId name:(NSString *)name site:(BOOL)site error:(NSError **)error;
- (NSNumber *)getGroupsCountWithCompanyId:(long long)companyId parentGroupId:(long long)parentGroupId site:(BOOL)site error:(NSError **)error;
- (NSNumber *)getGroupsCountWithCompanyId:(long long)companyId className:(NSString *)className parentGroupId:(long long)parentGroupId error:(NSError **)error;
...
- (NSArray *)searchWithCompanyId:(long long)companyId classNameIds:(NSArray *)classNameIds keywords:(NSString *)keywords params:(NSDictionary *)params start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error;
- (NSArray *)searchWithCompanyId:(long long)companyId classNameIds:(NSArray *)classNameIds name:(NSString *)name description:(NSString *)description params:(NSDictionary *)params andOperator:(BOOL)andOperator start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error;
...
- (NSArray *)getGroupsWithCompanyId:(long long)companyId parentGroupId:(long long)parentGroupId site:(BOOL)site start:(int)start end:(int)end error:(NSError **)error;
- (NSArray *)getGroupsWithCompanyId:(long long)companyId parentGroupId:(long long)parentGroupId name:(NSString *)name site:(BOOL)site start:(int)start end:(int)end error:(NSError **)error;
