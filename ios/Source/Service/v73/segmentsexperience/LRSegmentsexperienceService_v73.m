...
#import "LRSegmentsexperienceService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRSegmentsexperienceService_v73
...
- (NSDictionary *)fetchSegmentsExperienceWithGroupId:(long long)groupId segmentsExperienceKey:(NSString *)segmentsExperienceKey error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"groupId": @(groupId),
		@"segmentsExperienceKey": [self checkNull: segmentsExperienceKey]
	}];

	NSDictionary *_command = @{@"/segments.segmentsexperience/fetch-segments-experience": _params};
