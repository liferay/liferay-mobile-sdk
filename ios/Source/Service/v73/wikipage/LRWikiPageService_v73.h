 ...
 */
@interface LRWikiPageService_v73 : LRBaseService
...
- (void)deleteTempFileEntryWithNodeId:(long long)nodeId folderName:(NSString *)folderName fileName:(NSString *)fileName error:(NSError **)error CONVERT_ERROR_TO_THROWS;
