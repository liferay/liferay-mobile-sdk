...
#import "LRWikiPageService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRWikiPageService_v73
...
- (NSArray *)getPagesWithGroupId:(long long)groupId nodeId:(long long)nodeId head:(BOOL)head status:(int)status start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"groupId": @(groupId),
		@"nodeId": @(nodeId),
		@"head": @(head),
	...
	[self mangleWrapperWithParams:_params name:@"orderByComparator" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.wiki.model.WikiPage>" wrapper:orderByComparator];
...
- (NSArray *)getPagesWithGroupId:(long long)groupId nodeId:(long long)nodeId head:(BOOL)head userId:(long long)userId includeOwner:(BOOL)includeOwner status:(int)status start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"groupId": @(groupId),
		@"nodeId": @(nodeId),
		@"head": @(head),
...
- (NSArray *)getOrphansWithNode:(LRJSONObjectWrapper *)node error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
	}];

	[self mangleWrapperWithParams:_params name:@"node" className:@"com.liferay.wiki.model.WikiNode" wrapper:node];
