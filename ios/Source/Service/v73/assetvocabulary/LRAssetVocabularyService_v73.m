...
#import "LRAssetVocabularyService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRAssetVocabularyService_v73
...
- (NSArray *)getGroupVocabulariesWithGroupId:(long long)groupId name:(NSString *)name start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"orderByComparator" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.asset.kernel.model.AssetVocabulary>" wrapper:orderByComparator];
...
- (NSArray *)getGroupVocabulariesWithGroupIds:(NSArray *)groupIds visibilityTypes:(NSArray *)visibilityTypes error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"groupIds": [self checkNull: groupIds],
		@"visibilityTypes": [self checkNull: visibilityTypes]
	}];
