 ...
 */
@interface LRDDMTemplateService_v73 : LRBaseService
...
- (NSArray *)getTemplatesWithCompanyId:(long long)companyId groupIds:(NSArray *)groupIds classNameIds:(NSArray *)classNameIds classPKs:(NSArray *)classPKs resourceClassNameId:(long long)resourceClassNameId start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error;
...
- (void)deleteTemplateWithTemplateId:(long long)templateId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
...
- (NSNumber *)getTemplatesCountWithCompanyId:(long long)companyId groupIds:(NSArray *)groupIds classNameIds:(NSArray *)classNameIds classPKs:(NSArray *)classPKs resourceClassNameId:(long long)resourceClassNameId error:(NSError **)error;
- (void)revertTemplateWithTemplateId:(long long)templateId version:(NSString *)version serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error CONVERT_ERROR_TO_THROWS;
