...
#import "LRLayoutSetPrototypeService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRLayoutSetPrototypeService_v73
...
- (NSArray *)searchWithCompanyId:(long long)companyId active:(BOOL)active orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	...
	[self mangleWrapperWithParams:_params name:@"orderByComparator" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.model.LayoutSetPrototype>" wrapper:orderByComparator];
