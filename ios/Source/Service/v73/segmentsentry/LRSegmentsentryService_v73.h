 ...
 */
@interface LRSegmentsentryService_v73 : LRBaseService
...
- (void)addSegmentsEntryClassPKsWithSegmentsEntryId:(long long)segmentsEntryId classPKs:(NSArray *)classPKs serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error CONVERT_ERROR_TO_THROWS;
- (void)deleteSegmentsEntryClassPKsWithSegmentsEntryId:(long long)segmentsEntryId classPKs:(NSArray *)classPKs error:(NSError **)error CONVERT_ERROR_TO_THROWS;
