...
#import "LRBlogsEntryService_v73.h"

/**
 * @author Bruno Farache
 */
@implementation LRBlogsEntryService_v73
...
- (NSDictionary *)updateEntryWithEntryId:(long long)entryId title:(NSString *)title subtitle:(NSString *)subtitle description:(NSString *)description content:(NSString *)content displayDateMonth:(int)displayDateMonth displayDateDay:(int)displayDateDay displayDateYear:(int)displayDateYear displayDateHour:(int)displayDateHour displayDateMinute:(int)displayDateMinute allowPingbacks:(BOOL)allowPingbacks allowTrackbacks:(BOOL)allowTrackbacks trackbacks:(NSArray *)trackbacks coverImageCaption:(NSString *)coverImageCaption coverImageImageSelector:(LRJSONObjectWrapper *)coverImageImageSelector smallImageImageSelector:(LRJSONObjectWrapper *)smallImageImageSelector serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/update-entry": _params};

	return (NSDictionary *)[self.session invoke:_command error:error];
}

- (NSDictionary *)updateEntryWithEntryId:(long long)entryId title:(NSString *)title subtitle:(NSString *)subtitle urlTitle:(NSString *)urlTitle description:(NSString *)description content:(NSString *)content displayDateMonth:(int)displayDateMonth displayDateDay:(int)displayDateDay displayDateYear:(int)displayDateYear displayDateHour:(int)displayDateHour displayDateMinute:(int)displayDateMinute allowPingbacks:(BOOL)allowPingbacks allowTrackbacks:(BOOL)allowTrackbacks trackbacks:(NSArray *)trackbacks coverImageCaption:(NSString *)coverImageCaption coverImageImageSelector:(LRJSONObjectWrapper *)coverImageImageSelector smallImageImageSelector:(LRJSONObjectWrapper *)smallImageImageSelector serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"entryId": @(entryId),
		@"title": [self checkNull: title],
		@"subtitle": [self checkNull: subtitle],
...
- (NSArray *)getCompanyEntriesWithCompanyId:(long long)companyId displayDate:(long long)displayDate status:(int)status max:(int)max error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/get-company-entries": _params};
...
- (NSArray *)getGroupEntriesWithGroupId:(long long)groupId status:(int)status start:(int)start end:(int)end error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/get-group-entries": _params};
...
- (NSArray *)getGroupEntriesWithGroupId:(long long)groupId status:(int)status start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"groupId": @(groupId),
		@"status": @(status),
		@"start": @(start),
	...
	[self mangleWrapperWithParams:_params name:@"orderByComparator" className:@"com.liferay.portal.kernel.util.OrderByComparator<com.liferay.blogs.model.BlogsEntry>" wrapper:orderByComparator];
...
- (NSDictionary *)addAttachmentsFolderWithGroupId:(long long)groupId error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"groupId": @(groupId)
	}];

	NSDictionary *_command = @{@"/blogs.blogsentry/add-attachments-folder": _params};
...
- (void)unsubscribeWithGroupId:(long long)groupId error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/unsubscribe": _params};
...
- (void)subscribeWithGroupId:(long long)groupId error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/subscribe": _params};

	[self.session invoke:_command error:error];
}

- (NSArray *)getEntriesPrevAndNextWithEntryId:(long long)entryId error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"entryId": @(entryId)
	}];

	NSDictionary *_command = @{@"/blogs.blogsentry/get-entries-prev-and-next": _params};
...
- (NSNumber *)getGroupEntriesCountWithGroupId:(long long)groupId status:(int)status error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/get-group-entries-count": _params};
...
- (NSArray *)getGroupsEntriesWithCompanyId:(long long)companyId groupId:(long long)groupId displayDate:(long long)displayDate status:(int)status max:(int)max error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/get-groups-entries": _params};

	return (NSArray *)[self.session invoke:_command error:error];
}

- (NSArray *)getGroupUserEntriesWithGroupId:(long long)groupId userId:(long long)userId status:(int)status start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"groupId": @(groupId),
		@"userId": @(userId),
		@"status": @(status),
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/get-group-user-entries": _params};

	return (NSArray *)[self.session invoke:_command error:error];
}

- (NSArray *)getGroupUserEntriesWithGroupId:(long long)groupId userId:(long long)userId statuses:(NSArray *)statuses start:(int)start end:(int)end orderByComparator:(LRJSONObjectWrapper *)orderByComparator error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"groupId": @(groupId),
		@"userId": @(userId),
...
- (NSNumber *)getGroupUserEntriesCountWithGroupId:(long long)groupId userId:(long long)userId status:(int)status error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/get-group-user-entries-count": _params};
...
- (NSArray *)getOrganizationEntriesWithOrganizationId:(long long)organizationId displayDate:(long long)displayDate status:(int)status max:(int)max error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/get-organization-entries": _params};
...
- (NSDictionary *)moveEntryToTrashWithEntryId:(long long)entryId error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/move-entry-to-trash": _params};
...
- (void)restoreEntryFromTrashWithEntryId:(long long)entryId error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/restore-entry-from-trash": _params};
...
- (NSString *)getCompanyEntriesRssWithCompanyId:(long long)companyId displayDate:(long long)displayDate status:(int)status max:(int)max type:(NSString *)type version:(double)version displayStyle:(NSString *)displayStyle feedURL:(NSString *)feedURL entryURL:(NSString *)entryURL themeDisplay:(LRJSONObjectWrapper *)themeDisplay error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/get-company-entries-rss": _params};
...
- (NSString *)getGroupEntriesRssWithGroupId:(long long)groupId displayDate:(long long)displayDate status:(int)status max:(int)max type:(NSString *)type version:(double)version displayStyle:(NSString *)displayStyle feedURL:(NSString *)feedURL entryURL:(NSString *)entryURL themeDisplay:(LRJSONObjectWrapper *)themeDisplay error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/get-group-entries-rss": _params};
...
- (NSString *)getOrganizationEntriesRssWithOrganizationId:(long long)organizationId displayDate:(long long)displayDate status:(int)status max:(int)max type:(NSString *)type version:(double)version displayStyle:(NSString *)displayStyle feedURL:(NSString *)feedURL entryURL:(NSString *)entryURL themeDisplay:(LRJSONObjectWrapper *)themeDisplay error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/get-organization-entries-rss": _params};
...
- (NSDictionary *)addEntryWithTitle:(NSString *)title subtitle:(NSString *)subtitle description:(NSString *)description content:(NSString *)content displayDateMonth:(int)displayDateMonth displayDateDay:(int)displayDateDay displayDateYear:(int)displayDateYear displayDateHour:(int)displayDateHour displayDateMinute:(int)displayDateMinute allowPingbacks:(BOOL)allowPingbacks allowTrackbacks:(BOOL)allowTrackbacks trackbacks:(NSArray *)trackbacks coverImageCaption:(NSString *)coverImageCaption coverImageImageSelector:(LRJSONObjectWrapper *)coverImageImageSelector smallImageImageSelector:(LRJSONObjectWrapper *)smallImageImageSelector serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/add-entry": _params};

	return (NSDictionary *)[self.session invoke:_command error:error];
}

- (NSDictionary *)addEntryWithTitle:(NSString *)title subtitle:(NSString *)subtitle urlTitle:(NSString *)urlTitle description:(NSString *)description content:(NSString *)content displayDateMonth:(int)displayDateMonth displayDateDay:(int)displayDateDay displayDateYear:(int)displayDateYear displayDateHour:(int)displayDateHour displayDateMinute:(int)displayDateMinute allowPingbacks:(BOOL)allowPingbacks allowTrackbacks:(BOOL)allowTrackbacks trackbacks:(NSArray *)trackbacks coverImageCaption:(NSString *)coverImageCaption coverImageImageSelector:(LRJSONObjectWrapper *)coverImageImageSelector smallImageImageSelector:(LRJSONObjectWrapper *)smallImageImageSelector serviceContext:(LRJSONObjectWrapper *)serviceContext error:(NSError **)error {
	NSMutableDictionary *_params = [NSMutableDictionary dictionaryWithDictionary:@{
		@"title": [self checkNull: title],
		@"subtitle": [self checkNull: subtitle],
		@"urlTitle": [self checkNull: urlTitle],
...
- (NSDictionary *)getEntryWithEntryId:(long long)entryId error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/get-entry": _params};
...
- (void)deleteEntryWithEntryId:(long long)entryId error:(NSError **)error {
	...
	NSDictionary *_command = @{@"/blogs.blogsentry/delete-entry": _params};
