...
package com.liferay.mobile.android.v71.announcementsdelivery;
...
public class AnnouncementsDeliveryService extends BaseService {
	...
	public JSONObject updateDelivery(long userId, String type, boolean email, boolean sms) throws Exception {
