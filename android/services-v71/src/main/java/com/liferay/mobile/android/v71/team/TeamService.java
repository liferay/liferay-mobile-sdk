...
package com.liferay.mobile.android.v71.team;
...
public class TeamService extends BaseService {
	...
	public JSONArray search(long groupId, String name, String description, JSONObject params, int start, int end, JSONObjectWrapper obc) throws Exception {
		...
		try {
			...
			_params.put("end", end);
			mangleWrapper(_params, "obc", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.model.Team>", obc);
