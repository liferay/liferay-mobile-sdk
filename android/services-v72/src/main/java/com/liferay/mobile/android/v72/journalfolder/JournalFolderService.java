...
package com.liferay.mobile.android.v72.journalfolder;
...
public class JournalFolderService extends BaseService {
	...
	public JSONArray getFoldersAndArticles(long groupId, long userId, long folderId, int status, String locale, int start, int end, JSONObjectWrapper obc) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray searchDdmStructures(long companyId, JSONArray groupIds, long folderId, int restrictionType, String keywords, int start, int end, JSONObjectWrapper obc) throws Exception {
		...
		try {
			...
			_params.put("restrictionType", restrictionType);
			_params.put("start", start);
			mangleWrapper(_params, "obc", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.mapping.model.DDMStructure>", obc);
