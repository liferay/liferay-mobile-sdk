...
package com.liferay.mobile.android.v72.dlapp;
...
public class DLAppService extends BaseService {
	...
	public JSONArray getFoldersAndFileEntriesAndFileShortcuts(long repositoryId, long folderId, int status, JSONArray mimeTypes, boolean includeMountFolders, boolean includeOwner, int start, int end, JSONObjectWrapper obc) throws Exception {
		JSONObject _command = new JSONObject();
