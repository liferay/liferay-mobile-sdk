...
package com.liferay.mobile.android.v72.assetentry;
...
public class AssetEntryService extends BaseService {
	...
	public void incrementViewCounter(JSONObjectWrapper assetEntry) throws Exception {
		JSONObject _command = new JSONObject();

		try {
			JSONObject _params = new JSONObject();

			mangleWrapper(_params, "assetEntry", "com.liferay.asset.kernel.model.AssetEntry", assetEntry);
	...
	public JSONObject updateEntry(long groupId, long createDate, long modifiedDate, String className, long classPK, String classUuid, long classTypeId, JSONArray categoryIds, JSONArray tagNames, boolean listable, boolean visible, long startDate, long endDate, long expirationDate, String mimeType, String title, String description, String summary, String url, String layoutUuid, int height, int width, double priority) throws Exception {
		JSONObject _command = new JSONObject();
