...
package com.liferay.mobile.android.v73.mbcategory;
...
public class MBCategoryService extends BaseService {
	...
	public JSONArray getCategoriesAndThreads(long groupId, long categoryId, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
