...
package com.liferay.mobile.android.v73.contact;
...
public class ContactService extends BaseService {
	...
	public JSONArray getCompanyContacts(long companyId, int start, int end) throws Exception {
		...
		try {
			...
			_command.put("/contact/get-company-contacts", _params);
		}
	...
	public Integer getCompanyContactsCount(long companyId) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/contact/get-company-contacts-count", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONArray getContacts(long classNameId, long classPK, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		...
		try {
			...
			_params.put("end", end);
			_params.put("start", start);
			mangleWrapper(_params, "orderByComparator", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.model.Contact>", orderByComparator);
