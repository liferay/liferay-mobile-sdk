...
package com.liferay.mobile.android.v73.ddmforminstancerecordversion;
...
public class DdmforminstancerecordversionService extends BaseService {
	...
	public JSONObject fetchLatestFormInstanceRecordVersion(long userId, long formInstanceId, String formInstanceVersion, int status) throws Exception {
		...
		try {
			...
			_params.put("formInstanceVersion", checkNull(formInstanceVersion));
			_params.put("status", status);
			_params.put("userId", userId);

			_command.put("/ddm.ddmforminstancerecordversion/fetch-latest-form-instance-record-version", _params);
		}
