...
package com.liferay.mobile.android.v73.role;
...
public class RoleService extends BaseService {
	...
	public JSONArray search(long companyId, String keywords, JSONArray types, JSONObject params, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("start", start);
			_params.put("types", checkNull(types));
			mangleWrapper(_params, "orderByComparator", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.model.Role>", orderByComparator);
