...
package com.liferay.mobile.android.v73.ddmstructure;
...
public class DDMStructureService extends BaseService {
	...
	public JSONObject addStructure(long groupId, long classNameId, JSONObject nameMap, JSONObject descriptionMap, JSONObjectWrapper ddmForm, JSONObjectWrapper ddmFormLayout, String storageType, JSONObjectWrapper serviceContext) throws Exception {
	...
	public JSONObject addStructure(long groupId, String parentStructureKey, long classNameId, String structureKey, JSONObject nameMap, JSONObject descriptionMap, JSONObjectWrapper ddmForm, JSONObjectWrapper ddmFormLayout, String storageType, int type, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getStructures(long companyId, JSONArray groupIds, long classNameId, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getStructures(long companyId, JSONArray groupIds, long classNameId, String keywords, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getStructuresCount(long companyId, JSONArray groupIds, long classNameId) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/ddm.ddmstructure/get-structures-count", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public Integer getStructuresCount(long companyId, JSONArray groupIds, long classNameId, String keywords, int status) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray search(long companyId, JSONArray groupIds, long classNameId, String keywords, int type, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer searchCount(long companyId, JSONArray groupIds, long classNameId, String keywords, int type, int status) throws Exception {
		JSONObject _command = new JSONObject();
