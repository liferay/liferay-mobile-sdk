...
package com.liferay.mobile.android.v73.ddmforminstanceversion;
...
public class DdmforminstanceversionService extends BaseService {
	...
	public JSONObject getLatestFormInstanceVersion(long ddmFormInstanceId, int status) throws Exception {
		JSONObject _command = new JSONObject();
