...
package com.liferay.mobile.android.v73.ddmtemplate;
...
public class DDMTemplateService extends BaseService {
	...
	public JSONArray getTemplates(long companyId, JSONArray groupIds, JSONArray classNameIds, JSONArray classPKs, long resourceClassNameId, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getTemplatesCount(long companyId, JSONArray groupIds, JSONArray classNameIds, JSONArray classPKs, long resourceClassNameId) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/ddm.ddmtemplate/get-templates-count", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
