...
package com.liferay.mobile.android.v73.wikipage;
...
public class WikiPageService extends BaseService {
	...
	public JSONArray addPageAttachments(long nodeId, String title, JSONArray inputStreamOVPs) throws Exception {
		...
		try {
			...
			_command.put("/wiki.wikipage/add-page-attachments", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONArray getOrphans(JSONObjectWrapper node) throws Exception {
		JSONObject _command = new JSONObject();

		try {
			JSONObject _params = new JSONObject();

			mangleWrapper(_params, "node", "com.liferay.wiki.model.WikiNode", node);
	...
	public JSONArray getPages(long groupId, long nodeId, boolean head, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			mangleWrapper(_params, "orderByComparator", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.wiki.model.WikiPage>", orderByComparator);
	...
	public JSONArray getPages(long groupId, long nodeId, boolean head, long userId, boolean includeOwner, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
