...
package com.liferay.mobile.android.v73.dlfileentry;
...
public class DLFileEntryService extends BaseService {
	...
	public JSONArray getFileEntries(long groupId, long folderId, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			mangleWrapper(_params, "orderByComparator", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.document.library.kernel.model.DLFileEntry>", orderByComparator);
	...
	public JSONArray getFileEntries(long groupId, long folderId, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getFileEntries(long groupId, long folderId, JSONArray mimeTypes, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getFileEntries(long groupId, long folderId, JSONArray mimeTypes, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getFileEntries(long groupId, long folderId, long fileEntryTypeId, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getFileEntriesCount(long groupId, long folderId, JSONArray mimeTypes, int status) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getGroupFileEntries(long groupId, long userId, long repositoryId, long rootFolderId, JSONArray mimeTypes, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
