...
package com.liferay.mobile.android.v73.assetlistentry;
...
public class AssetlistentryService extends BaseService {
	...
	public JSONArray getAssetListEntries(JSONArray groupIds, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getAssetListEntries(JSONArray groupIds, JSONArray assetEntryTypes, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();

		try {
			JSONObject _params = new JSONObject();

			_params.put("assetEntryTypes", checkNull(assetEntryTypes));
			_params.put("end", end);
			_params.put("groupIds", checkNull(groupIds));
			_params.put("start", start);
			mangleWrapper(_params, "orderByComparator", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.asset.list.model.AssetListEntry>", orderByComparator);
	...
	public JSONArray getAssetListEntries(JSONArray groupIds, String title, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getAssetListEntries(JSONArray groupIds, String title, JSONArray assetEntryTypes, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getAssetListEntries(JSONArray groupIds, String assetEntrySubtype, String assetEntryType, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();

		try {
			JSONObject _params = new JSONObject();

			_params.put("assetEntrySubtype", checkNull(assetEntrySubtype));
			_params.put("assetEntryType", checkNull(assetEntryType));
			_params.put("end", end);
			_params.put("groupIds", checkNull(groupIds));
			_params.put("start", start);
			mangleWrapper(_params, "orderByComparator", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.asset.list.model.AssetListEntry>", orderByComparator);
	...
	public JSONArray getAssetListEntries(JSONArray groupIds, String title, String assetEntrySubtype, String assetEntryType, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getAssetListEntriesCount(JSONArray groupIds) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getAssetListEntriesCount(JSONArray groupIds, JSONArray assetEntryTypes) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getAssetListEntriesCount(JSONArray groupIds, String title) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getAssetListEntriesCount(JSONArray groupIds, String title, JSONArray assetEntryTypes) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getAssetListEntriesCount(JSONArray groupIds, String assetEntrySubtype, String assetEntryType) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getAssetListEntriesCount(JSONArray groupIds, String title, String assetEntrySubtype, String assetEntryType) throws Exception {
		JSONObject _command = new JSONObject();
