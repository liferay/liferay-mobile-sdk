...
package com.liferay.mobile.android.v73.segmentsexperience;
...
public class SegmentsexperienceService extends BaseService {
	...
	public JSONObject fetchSegmentsExperience(long groupId, String segmentsExperienceKey) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("segmentsExperienceKey", checkNull(segmentsExperienceKey));

			_command.put("/segments.segmentsexperience/fetch-segments-experience", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
