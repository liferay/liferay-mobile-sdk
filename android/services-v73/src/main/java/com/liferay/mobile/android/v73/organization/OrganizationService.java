...
package com.liferay.mobile.android.v73.organization;
...
public class OrganizationService extends BaseService {
	...
	public JSONArray getGtOrganizations(long gtOrganizationId, long companyId, long parentOrganizationId, int size) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("gtOrganizationId", gtOrganizationId);
			_params.put("parentOrganizationId", parentOrganizationId);
			_params.put("size", size);

			_command.put("/organization/get-gt-organizations", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONArray getOrganizations(long companyId, long parentOrganizationId, String name, int start, int end) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getOrganizationsCount(long companyId, long parentOrganizationId, String name) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject updateOrganization(long organizationId, long parentOrganizationId, String name, String type, long regionId, long countryId, long statusId, String comments, boolean hasLogo, byte[] logoBytes, boolean site, JSONArray addresses, JSONArray emailAddresses, JSONArray orgLabors, JSONArray phones, JSONArray websites, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
