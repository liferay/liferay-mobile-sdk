...
package com.liferay.mobile.android.v73.blogsentry;
...
public class BlogsEntryService extends BaseService {
	...
	public JSONArray getGroupEntries(long groupId, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("start", start);
			_params.put("status", status);
			mangleWrapper(_params, "orderByComparator", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.blogs.model.BlogsEntry>", orderByComparator);
	...
	public JSONArray getGroupUserEntries(long groupId, long userId, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getGroupUserEntries(long groupId, long userId, JSONArray statuses, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
