...
package com.liferay.mobile.android.v73.screensratingsentry;
 ...
 */
public class ScreensRatingEntryService extends BaseService {

	public ScreensRatingEntryService(Session session) {
		super(session);
	}
