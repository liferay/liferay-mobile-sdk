...
package com.liferay.mobile.android.v73.layout;
...
public class LayoutService extends BaseService {
	...
	public JSONObject addLayout(long groupId, boolean privateLayout, long parentLayoutId, JSONObject localeNamesMap, JSONObject localeTitlesMap, JSONObject descriptionMap, JSONObject keywordsMap, JSONObject robotsMap, String type, String typeSettings, boolean hidden, JSONObject friendlyURLMap, long masterLayoutPlid, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("localeNamesMap", checkNull(localeNamesMap));
			_params.put("localeTitlesMap", checkNull(localeTitlesMap));
			_params.put("masterLayoutPlid", masterLayoutPlid);
			_params.put("parentLayoutId", parentLayoutId);
			_params.put("privateLayout", privateLayout);
			_params.put("robotsMap", checkNull(robotsMap));
			_params.put("type", checkNull(type));
	...
	public JSONObject addLayout(long groupId, boolean privateLayout, long parentLayoutId, JSONObject localeNamesMap, JSONObject localeTitlesMap, JSONObject descriptionMap, JSONObject keywordsMap, JSONObject robotsMap, String type, String typeSettings, boolean hidden, long masterLayoutPlid, JSONObject friendlyURLMap, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject addLayout(long groupId, boolean privateLayout, long parentLayoutId, long classNameId, long classPK, JSONObject localeNamesMap, JSONObject localeTitlesMap, JSONObject descriptionMap, JSONObject keywordsMap, JSONObject robotsMap, String type, String typeSettings, boolean hidden, boolean system, JSONObject friendlyURLMap, long masterLayoutPlid, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject addLayout(long groupId, boolean privateLayout, long parentLayoutId, long classNameId, long classPK, JSONObject localeNamesMap, JSONObject localeTitlesMap, JSONObject descriptionMap, JSONObject keywordsMap, JSONObject robotsMap, String type, String typeSettings, boolean hidden, boolean system, long masterLayoutPlid, JSONObject friendlyURLMap, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject fetchLayout(long groupId, boolean privateLayout, long layoutId) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/layout/fetch-layout", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONArray getLayouts(long groupId, boolean privateLayout, String type) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getLayouts(long groupId, boolean privateLayout, String type, int start, int end) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getLayouts(long groupId, boolean privateLayout, String keywords, JSONArray types, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			mangleWrapper(_params, "orderByComparator", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.model.Layout>", orderByComparator);
	...
	public Integer getLayoutsCount(long groupId, boolean privateLayout, String type) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getLayoutsCount(long groupId, boolean privateLayout, String keywords, JSONArray types) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject updateLayout(long groupId, boolean privateLayout, long layoutId, long parentLayoutId, JSONObject localeNamesMap, JSONObject localeTitlesMap, JSONObject descriptionMap, JSONObject keywordsMap, JSONObject robotsMap, String type, boolean hidden, JSONObject friendlyURLMap, boolean hasIconImage, byte[] iconBytes, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("friendlyURLMap", checkNull(friendlyURLMap));
			_params.put("groupId", groupId);
			_params.put("hasIconImage", hasIconImage);
			_params.put("hidden", hidden);
	...
	public JSONObject updateLayout(long groupId, boolean privateLayout, long layoutId, long parentLayoutId, JSONObject localeNamesMap, JSONObject localeTitlesMap, JSONObject descriptionMap, JSONObject keywordsMap, JSONObject robotsMap, String type, boolean hidden, JSONObject friendlyURLMap, boolean hasIconImage, byte[] iconBytes, long masterLayoutPlid, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject updateType(long plid, String type) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/layout/update-type", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
