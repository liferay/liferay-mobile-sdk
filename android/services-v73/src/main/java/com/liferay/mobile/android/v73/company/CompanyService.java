...
package com.liferay.mobile.android.v73.company;
...
public class CompanyService extends BaseService {
	...
	public JSONArray getCompanies() throws Exception {
		JSONObject _command = new JSONObject();

		try {
			JSONObject _params = new JSONObject();

			_command.put("/company/get-companies", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void removePreferences(long companyId, JSONArray keys) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("companyId", companyId);
			_params.put("keys", checkNull(keys));

			_command.put("/company/remove-preferences", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONObject updateCompany(long companyId, String virtualHost, String mx, String homeURL, boolean hasLogo, byte[] logoBytes, String name, String legalName, String legalId, String legalType, String sicCode, String tickerSymbol, String industry, String type, String size) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public void updatePreferences(long companyId, JSONObject unicodeProperties) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("companyId", companyId);
			_params.put("unicodeProperties", checkNull(unicodeProperties));

			_command.put("/company/update-preferences", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
