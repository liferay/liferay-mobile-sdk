...
package com.liferay.mobile.android.v73.trashentry;
...
public class TrashEntryService extends BaseService {
	...
	public void deleteEntries(JSONArray entryIds) throws Exception {
		...
		try {
			...
			_command.put("/trash.trashentry/delete-entries", _params);
		}
	...
	public void deleteEntry(long entryId) throws Exception {
		...
		try {
			...
			_command.put("/trash.trashentry/delete-entry", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONObject getEntries(long groupId) throws Exception {
		...
		try {
			...
			_command.put("/trash.trashentry/get-entries", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONObject getEntries(long groupId, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			mangleWrapper(_params, "orderByComparator", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.trash.model.TrashEntry>", orderByComparator);
	...
	public JSONObject getEntries(long groupId, String className, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public void moveEntry(String className, long classPK, long destinationContainerModelId, JSONObjectWrapper serviceContext) throws Exception {
		...
		try {
			...
			_command.put("/trash.trashentry/move-entry", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONObject restoreEntry(long entryId) throws Exception {
		...
		try {
			...
			_command.put("/trash.trashentry/restore-entry", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
