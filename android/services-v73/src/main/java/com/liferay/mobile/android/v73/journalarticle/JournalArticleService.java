...
package com.liferay.mobile.android.v73.journalarticle;
...
public class JournalArticleService extends BaseService {
	...
	public JSONArray getArticlesByLayoutUuid(long groupId, String layoutUuid, int start, int end) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getArticlesByArticleId(long groupId, String articleId, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getArticles(long groupId, long folderId, String locale, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject addArticleDefaultValues(long groupId, long classNameId, long classPK, JSONObject titleMap, JSONObject descriptionMap, String content, String ddmStructureKey, String ddmTemplateKey, String layoutUuid, boolean indexable, boolean smallImage, String smallImageURL, UploadData smallImageFile, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/journal.journalarticle/add-article-default-values", _params);
		}
		catch (JSONException _je) {
			throw new Exception(_je);
		}
	...
	public void deleteArticleDefaultValues(long groupId, String articleId, String ddmStructureKey) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/journal.journalarticle/delete-article-default-values", _params);
		}
		catch (JSONException _je) {
			throw new Exception(_je);
		}
	...
	public JSONArray getArticlesByStructureId(long groupId, String ddmStructureKey, String locale, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getArticlesByStructureId(long groupId, String ddmStructureKey, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getArticlesByStructureId(long groupId, long classNameId, String ddmStructureKey, String locale, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getArticlesByStructureId(long groupId, long classNameId, String ddmStructureKey, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getArticlesByStructureId(long groupId, String ddmStructureKey, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject updateArticleDefaultValues(long groupId, String articleId, JSONObject titleMap, JSONObject descriptionMap, String content, String ddmStructureKey, String ddmTemplateKey, String layoutUuid, boolean indexable, boolean smallImage, String smallImageURL, UploadData smallImageFile, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/journal.journalarticle/update-article-default-values", _params);
		}
		catch (JSONException _je) {
			throw new Exception(_je);
		}
	...
	public JSONArray getLatestArticles(long groupId, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getArticlesByLayoutUuidCount(long groupId, String layoutUuid) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/journal.journalarticle/get-articles-by-layout-uuid-count", _params);
		}
		catch (JSONException _je) {
			throw new Exception(_je);
		}
	...
	public JSONArray getLayoutArticles(long groupId, int start, int end) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getLayoutArticlesCount(long groupId) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/journal.journalarticle/get-layout-articles-count", _params);
		}
		catch (JSONException _je) {
			throw new Exception(_je);
		}
	...
	public JSONArray search(long companyId, long groupId, JSONArray folderIds, long classNameId, String articleId, double version, String title, String description, String content, JSONArray ddmStructureKeys, JSONArray ddmTemplateKeys, long displayDateGT, long displayDateLT, int status, long reviewDate, boolean andOperator, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray search(long companyId, long groupId, JSONArray folderIds, long classNameId, String articleId, double version, String title, String description, String content, String ddmStructureKey, String ddmTemplateKey, long displayDateGT, long displayDateLT, int status, long reviewDate, boolean andOperator, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray search(long companyId, long groupId, JSONArray folderIds, long classNameId, String keywords, double version, String ddmStructureKey, String ddmTemplateKey, long displayDateGT, long displayDateLT, int status, long reviewDate, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
