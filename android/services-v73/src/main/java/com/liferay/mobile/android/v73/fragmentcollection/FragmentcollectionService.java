...
package com.liferay.mobile.android.v73.fragmentcollection;
...
public class FragmentcollectionService extends BaseService {
	...
	public JSONArray getFragmentCollections(JSONArray groupIds) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getFragmentCollections(JSONArray groupIds, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getFragmentCollections(JSONArray groupIds, String name, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getFragmentCollections(long groupId, boolean includeSystem) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("groupId", groupId);
			_params.put("includeSystem", includeSystem);
	...
	public JSONArray getFragmentCollections(long groupId, boolean includeSystem, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getFragmentCollections(long groupId, String name, boolean includeSystem, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getFragmentCollectionsCount(JSONArray groupIds) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getFragmentCollectionsCount(JSONArray groupIds, String name) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getFragmentCollectionsCount(long groupId, boolean includeSystem) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getFragmentCollectionsCount(long groupId, String name, boolean includeSystem) throws Exception {
		JSONObject _command = new JSONObject();
