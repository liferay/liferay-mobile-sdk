...
package com.liferay.mobile.android.v73.group;
...
public class GroupService extends BaseService {
	...
	public JSONArray getGroups(long companyId, long parentGroupId, boolean site, int start, int end) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getGroups(long companyId, long parentGroupId, String name, boolean site, int start, int end) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getGroupsCount(long companyId, long parentGroupId, boolean site) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/group/get-groups-count", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public Integer getGroupsCount(long companyId, long parentGroupId, String name, boolean site) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getGroupsCount(long companyId, String className, long parentGroupId) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getGtGroups(long gtGroupId, long companyId, long parentGroupId, boolean site, int size) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("companyId", companyId);
			_params.put("gtGroupId", gtGroupId);
			_params.put("parentGroupId", parentGroupId);
			_params.put("site", site);
			_params.put("size", size);

			_command.put("/group/get-gt-groups", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONArray getUserSitesGroups(long userId, int start, int end) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray search(long companyId, JSONArray classNameIds, String keywords, JSONObject params, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("start", start);
			mangleWrapper(_params, "orderByComparator", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.model.Group>", orderByComparator);
	...
	public JSONArray search(long companyId, JSONArray classNameIds, String name, String description, JSONObject params, boolean andOperator, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer searchCount(long companyId, JSONArray classNameIds, String keywords, JSONObject params) throws Exception {
		JSONObject _command = new JSONObject();
