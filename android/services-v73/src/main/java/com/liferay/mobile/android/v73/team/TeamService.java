...
package com.liferay.mobile.android.v73.team;
...
public class TeamService extends BaseService {
	...
	public JSONArray search(long groupId, String name, String description, JSONObject params, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			mangleWrapper(_params, "orderByComparator", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.portal.kernel.model.Team>", orderByComparator);
