...
package com.liferay.mobile.android.v73.mbmessage;
...
public class MBMessageService extends BaseService {
	...
	public JSONObject addDiscussionMessage(long groupId, String className, long classPK, long threadId, long parentMessageId, String subject, String body, JSONObjectWrapper serviceContext) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/add-discussion-message", _params);
		}
	...
	public JSONObject addMessage(long groupId, long categoryId, String subject, String body, String format, JSONArray inputStreamOVPs, boolean anonymous, double priority, boolean allowPingbacks, JSONObjectWrapper serviceContext) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/add-message", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void addMessageAttachment(long messageId, String fileName, UploadData file, String mimeType) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/add-message-attachment", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void deleteDiscussionMessage(long messageId) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/delete-discussion-message", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void deleteMessage(long messageId) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/delete-message", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void deleteMessageAttachment(long messageId, String fileName) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/delete-message-attachment", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void deleteMessageAttachments(long messageId) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/delete-message-attachments", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void deleteTempAttachment(long groupId, long categoryId, String folderName, String fileName) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/mb.mbmessage/delete-temp-attachment", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void emptyMessageAttachments(long messageId) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/empty-message-attachments", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONObject fetchMbMessageByUrlSubject(long groupId, String urlSubject) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("groupId", groupId);
			_params.put("urlSubject", checkNull(urlSubject));

			_command.put("/mb.mbmessage/fetch-mb-message-by-url-subject", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONArray getCategoryMessages(long groupId, long categoryId, int status, int start, int end) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/get-category-messages", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public Integer getCategoryMessagesCount(long groupId, long categoryId, int status) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/get-category-messages-count", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public String getCategoryMessagesRss(long groupId, long categoryId, int status, int max, String type, double version, String displayStyle, String feedURL, String entryURL, JSONObjectWrapper themeDisplay) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/get-category-messages-rss", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public String getCompanyMessagesRss(long companyId, int status, int max, String type, double version, String displayStyle, String feedURL, String entryURL, JSONObjectWrapper themeDisplay) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/get-company-messages-rss", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public Integer getGroupMessagesCount(long groupId, int status) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/get-group-messages-count", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public String getGroupMessagesRss(long groupId, int status, int max, String type, double version, String displayStyle, String feedURL, String entryURL, JSONObjectWrapper themeDisplay) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/get-group-messages-rss", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONObject getMessage(long messageId) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/get-message", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONObject getMessageDisplay(long messageId, int status) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/get-message-display", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONArray getTempAttachmentNames(long groupId, String folderName) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/mb.mbmessage/get-temp-attachment-names", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public Integer getThreadAnswersCount(long groupId, long categoryId, long threadId) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/get-thread-answers-count", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONArray getThreadMessages(long groupId, long categoryId, long threadId, int status, int start, int end) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/get-thread-messages", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public Integer getThreadMessagesCount(long groupId, long categoryId, long threadId, int status) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/get-thread-messages-count", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public String getThreadMessagesRss(long threadId, int status, int max, String type, double version, String displayStyle, String feedURL, String entryURL, JSONObjectWrapper themeDisplay) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/get-thread-messages-rss", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void moveMessageAttachmentToTrash(long messageId, String fileName) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/mb.mbmessage/move-message-attachment-to-trash", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void restoreMessageAttachmentFromTrash(long messageId, String fileName) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/restore-message-attachment-from-trash", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void subscribeMessage(long messageId) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/subscribe-message", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void unsubscribeMessage(long messageId) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/unsubscribe-message", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public void updateAnswer(long messageId, boolean answer, boolean cascade) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/update-answer", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONObject updateDiscussionMessage(String className, long classPK, long messageId, String subject, String body, JSONObjectWrapper serviceContext) throws Exception {
		...
		try {
			...
			_command.put("/mb.mbmessage/update-discussion-message", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONObject updateMessage(long messageId, String subject, String body, JSONArray inputStreamOVPs, double priority, boolean allowPingbacks, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/mb.mbmessage/update-message", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
