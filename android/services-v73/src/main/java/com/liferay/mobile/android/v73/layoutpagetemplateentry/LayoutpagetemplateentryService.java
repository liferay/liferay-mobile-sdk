...
package com.liferay.mobile.android.v73.layoutpagetemplateentry;
...
public class LayoutpagetemplateentryService extends BaseService {
	...
	public JSONObject addLayoutPageTemplateEntry(long groupId, long layoutPageTemplateCollectionId, long classNameId, long classTypeId, String name, int status, JSONObjectWrapper serviceContext) throws Exception {
	...
	public JSONObject addLayoutPageTemplateEntry(long groupId, long layoutPageTemplateCollectionId, long classNameId, long classTypeId, String name, long masterLayoutPlid, int status, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject addLayoutPageTemplateEntry(long groupId, long layoutPageTemplateCollectionId, String name, int type, long masterLayoutPlid, int status, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject addLayoutPageTemplateEntry(long groupId, long layoutPageTemplateCollectionId, String name, int status, long classNameId, long classTypeId, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject copyLayoutPageTemplateEntry(long groupId, long layoutPageTemplateCollectionId, long layoutPageTemplateEntryId, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/layout.layoutpagetemplateentry/copy-layout-page-template-entry", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
	...
	public JSONObject fetchDefaultLayoutPageTemplateEntry(long groupId, int type, int status) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getLayoutPageTemplateEntriesCount(long groupId, long layoutPageTemplateCollectionId) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getLayoutPageTemplateEntriesCount(long groupId, long layoutPageTemplateCollectionId, int status) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getLayoutPageTemplateEntriesCount(long groupId, long layoutPageTemplateCollectionId, String name) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getLayoutPageTemplateEntriesCount(long groupId, long layoutPageTemplateCollectionId, String name, int status) throws Exception {
		JSONObject _command = new JSONObject();
