...
package com.liferay.mobile.android.v73.assettag;
...
public class AssetTagService extends BaseService {
	...
	public JSONArray getGroupTags(long groupId, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			mangleWrapper(_params, "orderByComparator", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.asset.kernel.model.AssetTag>", orderByComparator);
	...
	public JSONArray getTags(JSONArray groupIds, String name, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getTags(long groupId, long classNameId, String name, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getTags(long groupId, String name, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public Integer getTagsCount(JSONArray groupIds, String name) throws Exception {
		JSONObject _command = new JSONObject();
