...
package com.liferay.mobile.android.v73.assetentry;
...
public class AssetEntryService extends BaseService {
	...
	public JSONObject getEntry(String className, long classPK) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject incrementViewCounter(long companyId, String className, long classPK) throws Exception {
		JSONObject _command = new JSONObject();
