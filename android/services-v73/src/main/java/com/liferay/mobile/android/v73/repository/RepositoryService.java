...
package com.liferay.mobile.android.v73.repository;
...
public class RepositoryService extends BaseService {
	...
	public JSONObject addRepository(long groupId, long classNameId, long parentFolderId, String name, String description, String portletId, JSONObject typeSettingsUnicodeProperties, JSONObjectWrapper serviceContext) throws Exception {
	...
	public JSONObject getRepository(long groupId, String portletId) throws Exception {
		JSONObject _command = new JSONObject();
