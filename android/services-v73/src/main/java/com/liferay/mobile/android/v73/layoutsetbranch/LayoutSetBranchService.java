...
package com.liferay.mobile.android.v73.layoutsetbranch;
...
public class LayoutSetBranchService extends BaseService {
	...
	public void deleteLayoutSetBranch(long currentLayoutPlid, long layoutSetBranchId) throws Exception {
		JSONObject _command = new JSONObject();

		try {
			JSONObject _params = new JSONObject();

			_params.put("currentLayoutPlid", currentLayoutPlid);
			_params.put("layoutSetBranchId", layoutSetBranchId);
