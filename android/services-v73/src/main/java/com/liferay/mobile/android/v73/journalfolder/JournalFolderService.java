...
package com.liferay.mobile.android.v73.journalfolder;
...
public class JournalFolderService extends BaseService {
	...
	public JSONArray getDdmStructures(JSONArray groupIds, long folderId, int restrictionType, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getFoldersAndArticles(long groupId, long folderId, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getFoldersAndArticles(long groupId, long folderId, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getFoldersAndArticles(long groupId, long userId, long folderId, int status, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray getFoldersAndArticles(long groupId, long userId, long folderId, int status, String locale, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONArray searchDdmStructures(long companyId, JSONArray groupIds, long folderId, int restrictionType, String keywords, int start, int end, JSONObjectWrapper orderByComparator) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/journal.journalfolder/search-ddm-structures", _params);
		}
		catch (JSONException jsone) {
			throw new Exception(jsone);
		}
