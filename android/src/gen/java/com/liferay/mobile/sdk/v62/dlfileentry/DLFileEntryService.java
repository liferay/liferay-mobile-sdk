...
public interface DLFileEntryService {
  ...
  @Path("/check-in-file-entry")
  Call<Response> checkInFileEntry(@Param("fileEntryId") long fileEntryId, @Param("major") boolean major, @Param("changeLog") String changeLog, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);

  @Path("/check-out-file-entry")
  Call<JSONObject> checkOutFileEntry(@Param("fileEntryId") long fileEntryId);

  @Path("/check-out-file-entry")
  Call<JSONObject> checkOutFileEntry(@Param("fileEntryId") long fileEntryId, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
  ...
  Call<JSONObject> copyFileEntry(@Param("groupId") long groupId, @Param("repositoryId") long repositoryId, @Param("fileEntryId") long fileEntryId, @Param("destFolderId") long destFolderId, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
  ...
  Call<JSONArray> getFileEntries(@Param("groupId") long groupId, @Param("folderId") long folderId, @Param("start") int start, @Param("end") int end, @ParamObject(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject obc);

  @Path("/get-file-entries")
  Call<JSONArray> getFileEntries(@Param("groupId") long groupId, @Param("folderId") long folderId, @Param("fileEntryTypeId") long fileEntryTypeId, @Param("start") int start, @Param("end") int end, @ParamObject(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject obc);

  @Path("/get-file-entries")
  Call<JSONArray> getFileEntries(@Param("groupId") long groupId, @Param("folderId") long folderId, @Param("mimeTypes") JSONArray mimeTypes, @Param("start") int start, @Param("end") int end, @ParamObject(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject obc);

  @Path("/get-file-entries")
  Call<JSONArray> getFileEntries(@Param("groupId") long groupId, @Param("folderId") long folderId, @Param("status") int status, @Param("start") int start, @Param("end") int end, @ParamObject(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject obc);
