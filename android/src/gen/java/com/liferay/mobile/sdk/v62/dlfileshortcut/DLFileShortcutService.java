...
public interface DLFileShortcutService {
  ...
  Call<JSONObject> addFileShortcut(@Param(name = "groupId") long groupId, @Param(name = "folderId") long folderId, @Param(name = "toFileEntryId") long toFileEntryId, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
