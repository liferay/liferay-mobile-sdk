...
public interface DLFileShortcutService {
  ...
  Call<JSONObject> addFileShortcut(@Param("groupId") long groupId, @Param("folderId") long folderId, @Param("toFileEntryId") long toFileEntryId, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
