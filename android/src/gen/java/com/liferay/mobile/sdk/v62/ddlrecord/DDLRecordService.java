...
public interface DDLRecordService {
  ...
  @Path("/add-record")
  Call<JSONObject> addRecord(@Param("groupId") long groupId, @Param("recordSetId") long recordSetId, @Param("displayIndex") int displayIndex, @ParamObject(name = "fieldsMap", className = "") JSONObject fieldsMap, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
