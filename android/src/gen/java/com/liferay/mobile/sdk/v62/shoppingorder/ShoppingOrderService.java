...
public interface ShoppingOrderService {
  ...
  @Path("/send-email")
  Call<Response> sendEmail(@Param("groupId") long groupId, @Param("orderId") long orderId, @Param("emailType") String emailType, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
