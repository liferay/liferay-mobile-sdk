...
public interface ShoppingOrderService {
  ...
  @Path("/send-email")
  Call<Response> sendEmail(@Param(name = "groupId") long groupId, @Param(name = "orderId") long orderId, @Param(name = "emailType") String emailType, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
