...
public interface AssetTagService {
  @Path("/add-tag")
  Call<JSONObject> addTag(@Param(name = "name") String name, @Param(name = "tagProperties") JSONArray tagProperties, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
  ...
  @Path("/get-group-tags")
  Call<JSONArray> getGroupTags(@Param(name = "groupId") long groupId, @Param(name = "start") int start, @Param(name = "end") int end, @ParamObject(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject obc);
  ...
  @Path("/get-tags")
  Call<JSONArray> getTags(@Param(name = "groupId") long groupId, @Param(name = "classNameId") long classNameId, @Param(name = "name") String name, @Param(name = "start") int start, @Param(name = "end") int end, @ParamObject(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject obc);
  ...
  @Path("/update-tag")
  Call<JSONObject> updateTag(@Param(name = "tagId") long tagId, @Param(name = "name") String name, @Param(name = "tagProperties") JSONArray tagProperties, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
}
