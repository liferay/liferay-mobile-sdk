...
public interface ShoppingItemService {
  ...
  @Path("/get-items")
  Call<JSONArray> getItems(@Param(name = "groupId") long groupId, @Param(name = "categoryId") long categoryId, @Param(name = "start") int start, @Param(name = "end") int end, @ParamObject(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject obc);
  ...
  Call<JSONArray> getItemsPrevAndNext(@Param(name = "itemId") long itemId, @ParamObject(name = "obc", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject obc);
