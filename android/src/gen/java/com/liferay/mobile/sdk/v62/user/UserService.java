...
public interface UserService {
  ...
  Call<Response> addGroupUsers(@Param("groupId") long groupId, @Param("userIds") JSONArray userIds, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
  ...
  Call<Response> unsetGroupUsers(@Param("groupId") long groupId, @Param("userIds") JSONArray userIds, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
  ...
  Call<JSONObject> updateEmailAddress(@Param("userId") long userId, @Param("password") String password, @Param("emailAddress1") String emailAddress1, @Param("emailAddress2") String emailAddress2, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
  ...
  Call<Response> updateOrganizations(@Param("userId") long userId, @Param("organizationIds") JSONArray organizationIds, @ParamObject(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
