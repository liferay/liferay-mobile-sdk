...
public interface ResourcePermissionService {
  ...
  Call<Response> setIndividualResourcePermissions(@Param("groupId") long groupId, @Param("companyId") long companyId, @Param("name") String name, @Param("primKey") String primKey, @Param("roleIdsToActionIds") JSONObject roleIdsToActionIds);
