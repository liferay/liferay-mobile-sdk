...
package com.liferay.mobile.android.v71.trashentry;
...
public class TrashEntryService extends BaseService {
	...
	public JSONObject getEntries(long groupId, int start, int end, JSONObjectWrapper obc) throws Exception {
		...
		try {
			...
			_params.put("end", end);
			mangleWrapper(_params, "obc", "com.liferay.portal.kernel.util.OrderByComparator<com.liferay.trash.kernel.model.TrashEntry>", obc);
