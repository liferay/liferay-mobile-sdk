...
public interface DLFileEntryService {
  ...
  @Path("/check-in-file-entry")
  Call<Response> checkInFileEntry(@Param("fileEntryId") long fileEntryId, @Param("major") boolean major, @Param("changeLog") String changeLog, @Param("serviceContext") JSONObjectWrapper serviceContext);

  @Path("/check-out-file-entry")
  Call<JSONObject> checkOutFileEntry(@Param("fileEntryId") long fileEntryId);

  @Path("/check-out-file-entry")
  Call<JSONObject> checkOutFileEntry(@Param("fileEntryId") long fileEntryId, @Param("serviceContext") JSONObjectWrapper serviceContext);
  ...
  Call<JSONObject> copyFileEntry(@Param("groupId") long groupId, @Param("repositoryId") long repositoryId, @Param("fileEntryId") long fileEntryId, @Param("destFolderId") long destFolderId, @Param("serviceContext") JSONObjectWrapper serviceContext);
  ...
  Call<JSONArray> getFileEntries(@Param("groupId") long groupId, @Param("folderId") long folderId, @Param("start") int start, @Param("end") int end, @Param("obc") JSONObjectWrapper obc);

  @Path("/get-file-entries")
  Call<JSONArray> getFileEntries(@Param("groupId") long groupId, @Param("folderId") long folderId, @Param("fileEntryTypeId") long fileEntryTypeId, @Param("start") int start, @Param("end") int end, @Param("obc") JSONObjectWrapper obc);

  @Path("/get-file-entries")
  Call<JSONArray> getFileEntries(@Param("groupId") long groupId, @Param("folderId") long folderId, @Param("mimeTypes") JSONArray mimeTypes, @Param("start") int start, @Param("end") int end, @Param("obc") JSONObjectWrapper obc);

  @Path("/get-file-entries")
  Call<JSONArray> getFileEntries(@Param("groupId") long groupId, @Param("folderId") long folderId, @Param("status") int status, @Param("start") int start, @Param("end") int end, @Param("obc") JSONObjectWrapper obc);
