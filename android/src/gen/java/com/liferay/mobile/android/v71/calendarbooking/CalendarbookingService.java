...
package com.liferay.mobile.android.v71.calendarbooking;
...
public class CalendarbookingService extends BaseService {
	...
	public JSONObject addCalendarBooking(long calendarId, JSONArray childCalendarIds, long parentCalendarBookingId, long recurringCalendarBookingId, JSONObject titleMap, JSONObject descriptionMap, String location, int startTimeYear, int startTimeMonth, int startTimeDay, int startTimeHour, int startTimeMinute, int endTimeYear, int endTimeMonth, int endTimeDay, int endTimeHour, int endTimeMinute, String timeZoneId, boolean allDay, String recurrence, long firstReminder, String firstReminderType, long secondReminder, String secondReminderType, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("childCalendarIds", checkNull(childCalendarIds));
			_params.put("parentCalendarBookingId", parentCalendarBookingId);
			_params.put("recurringCalendarBookingId", recurringCalendarBookingId);
			_params.put("titleMap", checkNull(titleMap));
			_params.put("descriptionMap", checkNull(descriptionMap));
			_params.put("location", checkNull(location));
			_params.put("startTimeYear", startTimeYear);
	...
	public JSONObject addCalendarBooking(long calendarId, JSONArray childCalendarIds, long parentCalendarBookingId, long recurringCalendarBookingId, JSONObject titleMap, JSONObject descriptionMap, String location, long startTime, long endTime, boolean allDay, String recurrence, long firstReminder, String firstReminderType, long secondReminder, String secondReminderType, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public void deleteCalendarBookingInstance(long calendarBookingId, int instanceIndex, boolean allFollowing, boolean deleteRecurringCalendarBookings) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("instanceIndex", instanceIndex);
			_params.put("allFollowing", allFollowing);
			_params.put("deleteRecurringCalendarBookings", deleteRecurringCalendarBookings);
	...
	public JSONArray getChildCalendarBookings(long parentCalendarBookingId, boolean includeStagingCalendarBookings) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("parentCalendarBookingId", parentCalendarBookingId);
			_params.put("includeStagingCalendarBookings", includeStagingCalendarBookings);
	...
	public JSONObject getLastInstanceCalendarBooking(long calendarBookingId) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/calendar.calendarbooking/get-last-instance-calendar-booking", _params);
		}
		catch (JSONException _je) {
			throw new Exception(_je);
		}
	...
	public JSONObject invokeTransition(long calendarBookingId, int instanceIndex, int status, boolean updateInstance, boolean allFollowing, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_params.put("instanceIndex", instanceIndex);
			_params.put("status", status);
			_params.put("updateInstance", updateInstance);
			_params.put("allFollowing", allFollowing);
			mangleWrapper(_params, "serviceContext", "com.liferay.portal.kernel.service.ServiceContext", serviceContext);
	...
	public JSONObject invokeTransition(long calendarBookingId, long startTime, int status, boolean updateInstance, boolean allFollowing, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public JSONObject updateCalendarBookingInstance(long calendarBookingId, int instanceIndex, long calendarId, JSONArray childCalendarIds, JSONObject titleMap, JSONObject descriptionMap, String location, long startTime, long endTime, boolean allDay, boolean allFollowing, long firstReminder, String firstReminderType, long secondReminder, String secondReminderType, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
	...
	public void updateLastInstanceCalendarBookingRecurrence(long calendarBookingId, String recurrence) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/calendar.calendarbooking/update-last-instance-calendar-booking-recurrence", _params);
		}
		catch (JSONException _je) {
			throw new Exception(_je);
		}
	...
	public JSONObject updateRecurringCalendarBooking(long calendarBookingId, long calendarId, JSONArray childCalendarIds, JSONObject titleMap, JSONObject descriptionMap, String location, long startTime, long endTime, boolean allDay, long firstReminder, String firstReminderType, long secondReminder, String secondReminderType, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/calendar.calendarbooking/update-recurring-calendar-booking", _params);
		}
		catch (JSONException _je) {
			throw new Exception(_je);
		}
	...
	public JSONObject updateRecurringCalendarBooking(long calendarBookingId, long calendarId, JSONArray childCalendarIds, JSONObject titleMap, JSONObject descriptionMap, String location, long startTime, long endTime, boolean allDay, String recurrence, long firstReminder, String firstReminderType, long secondReminder, String secondReminderType, JSONObjectWrapper serviceContext) throws Exception {
		JSONObject _command = new JSONObject();
