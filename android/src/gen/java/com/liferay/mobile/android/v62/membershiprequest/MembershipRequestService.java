...
public interface MembershipRequestService {
  ...
  Call<JSONObject> addMembershipRequest(@Param("groupId") long groupId, @Param("comments") String comments, @Param("serviceContext") JSONObjectWrapper serviceContext);
  ...
  @Path("/update-status")
  Call<Response> updateStatus(@Param("membershipRequestId") long membershipRequestId, @Param("reviewComments") String reviewComments, @Param("statusId") int statusId, @Param("serviceContext") JSONObjectWrapper serviceContext);
}
