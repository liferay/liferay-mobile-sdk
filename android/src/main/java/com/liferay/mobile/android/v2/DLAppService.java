...
public class DLAppService extends BaseService {
	...
	public Call<FileEntry> addFileEntry(long repositoryId, long folderId, String sourceFileName, String mimeType, String title, String description, String changeLog, UploadData file, JSONObjectWrapper serviceContext) throws Exception {
		...
		try {
			...
			_body.put("/dlapp/add-file-entry", _params);
		}
