...
public interface DDLRecordVersionService {
  ...
  @Path("/get-record-versions")
  Call<JSONArray> getRecordVersions(@Param(name = "recordId") long recordId, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "orderByComparator", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject orderByComparator);
