...
public interface DDLRecordSetService {
  ...
  @Path("/search")
  Call<JSONArray> search(@Param(name = "companyId") long companyId, @Param(name = "groupId") long groupId, @Param(name = "keywords") String keywords, @Param(name = "scope") int scope, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "orderByComparator", className = "") JSONObject orderByComparator);
  ...
  Call<JSONObject> updateMinDisplayRows(@Param(name = "recordSetId") long recordSetId, @Param(name = "minDisplayRows") int minDisplayRows, @Param(name = "serviceContext", className = "") JSONObject serviceContext);

  @Path("/update-record-set")
  Call<JSONObject> updateRecordSet(@Param(name = "recordSetId") long recordSetId, @Param(name = "settingsDDMFormValues", className = "") JSONObject settingsDDMFormValues);

  @Path("/update-record-set")
  Call<JSONObject> updateRecordSet(@Param(name = "recordSetId") long recordSetId, @Param(name = "ddmStructureId") long ddmStructureId, @Param(name = "nameMap", className = "") JSONObject nameMap, @Param(name = "descriptionMap", className = "") JSONObject descriptionMap, @Param(name = "minDisplayRows") int minDisplayRows, @Param(name = "serviceContext", className = "") JSONObject serviceContext);
