...
public interface DDMDataProviderInstanceService {
  ...
  Call<JSONObject> addDataProviderInstance(@Param(name = "groupId") long groupId, @Param(name = "nameMap", className = "") JSONObject nameMap, @Param(name = "descriptionMap", className = "") JSONObject descriptionMap, @Param(name = "ddmFormValues", className = "") JSONObject ddmFormValues, @Param(name = "type") String type, @Param(name = "serviceContext", className = "") JSONObject serviceContext);
  ...
  @Path("/search")
  Call<JSONArray> search(@Param(name = "companyId") long companyId, @Param(name = "groupIds") JSONArray groupIds, @Param(name = "keywords") String keywords, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "orderByComparator", className = "") JSONObject orderByComparator);

  @Path("/search")
  Call<JSONArray> search(@Param(name = "companyId") long companyId, @Param(name = "groupIds") JSONArray groupIds, @Param(name = "name") String name, @Param(name = "description") String description, @Param(name = "andOperator") boolean andOperator, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "orderByComparator", className = "") JSONObject orderByComparator);
  ...
  Call<JSONObject> updateDataProviderInstance(@Param(name = "dataProviderInstanceId") long dataProviderInstanceId, @Param(name = "nameMap", className = "") JSONObject nameMap, @Param(name = "descriptionMap", className = "") JSONObject descriptionMap, @Param(name = "ddmFormValues", className = "") JSONObject ddmFormValues, @Param(name = "serviceContext", className = "") JSONObject serviceContext);
}
