...
public interface OrganizationService {
  ...
  Call<JSONObject> addOrganization(@Param(name = "parentOrganizationId") long parentOrganizationId, @Param(name = "name") String name, @Param(name = "type") String type, @Param(name = "regionId") long regionId, @Param(name = "countryId") long countryId, @Param(name = "statusId") long statusId, @Param(name = "comments") String comments, @Param(name = "site") boolean site, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);

  @Path("/add-organization")
  Call<JSONObject> addOrganization(@Param(name = "parentOrganizationId") long parentOrganizationId, @Param(name = "name") String name, @Param(name = "type") String type, @Param(name = "regionId") long regionId, @Param(name = "countryId") long countryId, @Param(name = "statusId") long statusId, @Param(name = "comments") String comments, @Param(name = "site") boolean site, @Param(name = "addresses") JSONArray addresses, @Param(name = "emailAddresses") JSONArray emailAddresses, @Param(name = "orgLabors") JSONArray orgLabors, @Param(name = "phones") JSONArray phones, @Param(name = "websites") JSONArray websites, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
