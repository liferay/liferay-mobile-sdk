...
public interface ExpandoValueService {
  ...
  @Path("/get-data")
  Call<Map> getData(@Param(name = "companyId") long companyId, @Param(name = "className") String className, @Param(name = "tableName") String tableName, @Param(name = "columnName") String columnName, @Param(name = "classPK") long classPK);

  @Path("/get-data")
  Call<Map> getData(@Param(name = "companyId") long companyId, @Param(name = "className") String className, @Param(name = "tableName") String tableName, @Param(name = "columnNames") JSONArray columnNames, @Param(name = "classPK") long classPK);
