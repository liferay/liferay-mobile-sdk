package com.liferay.mobile.sdk.v7.wikinode;
...
public interface WikiNodeService {
  @Path("/add-node")
  Call<JSONObject> addNode(@Param(name = "name") String name, @Param(name = "description") String description, @Param(name = "serviceContext", className = "") JSONObject serviceContext);
  ...
  @Path("/get-nodes")
  Call<JSONArray> getNodes(@Param(name = "groupId") long groupId, @Param(name = "status") int status, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "obc", className = "") JSONObject obc);
  ...
  @Path("/update-node")
  Call<JSONObject> updateNode(@Param(name = "nodeId") long nodeId, @Param(name = "name") String name, @Param(name = "description") String description, @Param(name = "serviceContext", className = "") JSONObject serviceContext);
}
