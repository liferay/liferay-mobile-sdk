...
public interface DDMTemplateVersionService {
  ...
  Call<JSONArray> getTemplateVersions(@Param(name = "templateId") long templateId, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "orderByComparator", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject orderByComparator);
