...
public interface PhoneService {
  @Path("/add-phone")
  Call<JSONObject> addPhone(@Param(name = "className") String className, @Param(name = "classPK") long classPK, @Param(name = "number") String number, @Param(name = "extension") String extension, @Param(name = "typeId") long typeId, @Param(name = "primary") boolean primary, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
