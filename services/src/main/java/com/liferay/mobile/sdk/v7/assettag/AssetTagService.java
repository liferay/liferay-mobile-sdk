...
public interface AssetTagService {
  @Path("/add-tag")
  Call<JSONObject> addTag(@Param(name = "groupId") long groupId, @Param(name = "name") String name, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
  ...
  @Path("/update-tag")
  Call<JSONObject> updateTag(@Param(name = "tagId") long tagId, @Param(name = "name") String name, @Param(name = "serviceContext", className = "com.liferay.portal.kernel.service.ServiceContext") JSONObject serviceContext);
}
