...
public interface ExpandoValueService {
  ...
  @Path("/get-data")
  Call<JSONObject> getData(@Param(name = "companyId") long companyId, @Param(name = "className") String className, @Param(name = "tableName") String tableName, @Param(name = "columnNames", className = "java.util.Collection") JSONObject columnNames, @Param(name = "classPK") long classPK);
