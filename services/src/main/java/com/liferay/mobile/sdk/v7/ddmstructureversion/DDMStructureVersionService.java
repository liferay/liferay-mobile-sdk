...
public interface DDMStructureVersionService {
  ...
  Call<JSONArray> getStructureVersions(@Param(name = "structureId") long structureId, @Param(name = "start") int start, @Param(name = "end") int end, @Param(name = "orderByComparator", className = "com.liferay.portal.kernel.util.OrderByComparator") JSONObject orderByComparator);
