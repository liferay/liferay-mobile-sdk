...
public class PushnotificationsentryService extends BaseService {
	...
	public JSONObject dislikePushNotificationsEntry(long pushNotificationsEntryId) throws Exception {
		JSONObject _command = new JSONObject();
		...
		try {
			...
			_command.put("/push-notifications-portlet/pushnotificationsentry/dislike-push-notifications-entry", _params);
		}
		catch (JSONException _je) {
			throw new Exception(_je);
		}
