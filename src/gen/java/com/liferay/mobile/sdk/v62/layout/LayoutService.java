...
public interface LayoutService {
  ...
  @Path("/add-layout")
  Call<JSONObject> addLayout(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "parentLayoutId") long parentLayoutId, @Param(name = "localeNamesMap", className = "") JSONObject localeNamesMap, @Param(name = "localeTitlesMap", className = "") JSONObject localeTitlesMap, @Param(name = "descriptionMap", className = "") JSONObject descriptionMap, @Param(name = "keywordsMap", className = "") JSONObject keywordsMap, @Param(name = "robotsMap", className = "") JSONObject robotsMap, @Param(name = "type") String type, @Param(name = "hidden") boolean hidden, @Param(name = "friendlyURL") String friendlyURL, @Param(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);

  @Path("/add-layout")
  Call<JSONObject> addLayout(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "parentLayoutId") long parentLayoutId, @Param(name = "localeNamesMap", className = "") JSONObject localeNamesMap, @Param(name = "localeTitlesMap", className = "") JSONObject localeTitlesMap, @Param(name = "descriptionMap", className = "") JSONObject descriptionMap, @Param(name = "keywordsMap", className = "") JSONObject keywordsMap, @Param(name = "robotsMap", className = "") JSONObject robotsMap, @Param(name = "type") String type, @Param(name = "typeSettings") String typeSettings, @Param(name = "hidden") boolean hidden, @Param(name = "friendlyURLMap", className = "") JSONObject friendlyURLMap, @Param(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
  ...
  @Path("/update-layout")
  Call<JSONObject> updateLayout(@Param(name = "groupId") long groupId, @Param(name = "privateLayout") boolean privateLayout, @Param(name = "layoutId") long layoutId, @Param(name = "parentLayoutId") long parentLayoutId, @Param(name = "localeNamesMap", className = "") JSONObject localeNamesMap, @Param(name = "localeTitlesMap", className = "") JSONObject localeTitlesMap, @Param(name = "descriptionMap", className = "") JSONObject descriptionMap, @Param(name = "keywordsMap", className = "") JSONObject keywordsMap, @Param(name = "robotsMap", className = "") JSONObject robotsMap, @Param(name = "type") String type, @Param(name = "hidden") boolean hidden, @Param(name = "friendlyURL") String friendlyURL, @Param(name = "iconImage") boolean iconImage, @Param(name = "iconBytes") byte[] iconBytes, @Param(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
