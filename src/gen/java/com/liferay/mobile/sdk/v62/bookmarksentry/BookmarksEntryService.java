...
public interface BookmarksEntryService {
  @Path("/add-entry")
  Call<JSONObject> addEntry(@Param(name = "groupId") long groupId, @Param(name = "folderId") long folderId, @Param(name = "name") String name, @Param(name = "url") String url, @Param(name = "description") String description, @Param(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
  ...
  @Path("/open-entry")
  Call<JSONObject> openEntry(@Param(name = "entry", className = "com.liferay.portlet.bookmarks.model.BookmarksEntry") JSONObject entry);
  ...
  @Path("/update-entry")
  Call<JSONObject> updateEntry(@Param(name = "entryId") long entryId, @Param(name = "groupId") long groupId, @Param(name = "folderId") long folderId, @Param(name = "name") String name, @Param(name = "url") String url, @Param(name = "description") String description, @Param(name = "serviceContext", className = "com.liferay.portal.service.ServiceContext") JSONObject serviceContext);
}
