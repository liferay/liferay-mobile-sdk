...
namespace Liferay.SDK.Service.V72.Contact
{
	public class ContactService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> GetCompanyContactsAsync(long companyId, int start, int end)
		{
			var _parameters = new JsonObject();
			...
			var _command = new JsonObject()
			{
				{ "/contact/get-company-contacts", _parameters }
			};
		...
		public async Task<long> GetCompanyContactsCountAsync(long companyId)
		{
			var _parameters = new JsonObject();
			...
			var _command = new JsonObject()
			{
				{ "/contact/get-company-contacts-count", _parameters }
			};
