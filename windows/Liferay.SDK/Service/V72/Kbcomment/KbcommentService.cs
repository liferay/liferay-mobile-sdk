...
namespace Liferay.SDK.Service.V72.Kbcomment
{
	public class KbcommentService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> GetKbCommentsAsync(long groupId, string className, long classPK, int status, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetKbCommentsAsync(long groupId, string className, long classPK, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetKbCommentsAsync(long groupId, int status, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetKbCommentsAsync(long groupId, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
