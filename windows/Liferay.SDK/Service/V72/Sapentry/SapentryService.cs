...
namespace Liferay.SDK.Service.V72.Sapentry
{
	public class SapentryService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> GetCompanySapEntriesAsync(long companyId, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
