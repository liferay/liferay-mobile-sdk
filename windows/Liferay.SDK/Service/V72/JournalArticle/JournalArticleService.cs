...
namespace Liferay.SDK.Service.V72.JournalArticle
{
	public class JournalArticleService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> SearchAsync(long companyId, long groupId, IEnumerable<long> folderIds, long classNameId, string articleId, double version, string title, string description, string content, IEnumerable<string> ddmStructureKeys, IEnumerable<string> ddmTemplateKeys, long displayDateGT, long displayDateLT, int status, long reviewDate, bool andOperator, int start, int end, JsonObjectWrapper obc)
		{
		...
		public async Task<IEnumerable<dynamic>> SearchAsync(long companyId, long groupId, IEnumerable<long> folderIds, long classNameId, string articleId, double version, string title, string description, string content, string ddmStructureKey, string ddmTemplateKey, long displayDateGT, long displayDateLT, int status, long reviewDate, bool andOperator, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> SearchAsync(long companyId, long groupId, IEnumerable<long> folderIds, long classNameId, string keywords, double version, string ddmStructureKey, string ddmTemplateKey, long displayDateGT, long displayDateLT, int status, long reviewDate, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetArticlesByStructureIdAsync(long groupId, string ddmStructureKey, string locale, int status, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetArticlesByStructureIdAsync(long groupId, string ddmStructureKey, int status, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetArticlesByStructureIdAsync(long groupId, long classNameId, string ddmStructureKey, string locale, int status, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetLatestArticlesAsync(long groupId, int status, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetArticlesAsync(long groupId, long folderId, string locale, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
