...
namespace Liferay.SDK.Service.V72.WikiNode
{
	public class WikiNodeService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> GetNodesAsync(long groupId, int status, int start, int end, JsonObjectWrapper obc)
		{
			var _parameters = new JsonObject();
