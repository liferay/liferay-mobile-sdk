...
namespace Liferay.SDK.Service.V72.Kbarticle
{
	public class KbarticleService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> GetAllDescendantKbArticlesAsync(long resourcePrimKey, int status, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetKbArticleAndAllDescendantsAsync(long groupId, long resourcePrimKey, int status, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
			...
			var _command = new JsonObject()
			{
				{ "/kb.kbarticle/get-kb-article-and-all-descendants", _parameters }
			};
		...
		public async Task<IEnumerable<dynamic>> GetSiblingKbArticlesAsync(long groupId, long parentResourcePrimKey, int status, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
			...
			var _command = new JsonObject()
			{
				{ "/kb.kbarticle/get-sibling-kb-articles", _parameters }
			};
		...
		public async Task<long> GetSiblingKbArticlesCountAsync(long groupId, long parentResourcePrimKey, int status)
		{
			var _parameters = new JsonObject();
			...
			var _command = new JsonObject()
			{
				{ "/kb.kbarticle/get-sibling-kb-articles-count", _parameters }
			};
