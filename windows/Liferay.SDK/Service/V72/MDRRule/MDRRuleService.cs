...
namespace Liferay.SDK.Service.V72.MDRRule
{
	public class MDRRuleService : ServiceBase
	{
		...
		public async Task<dynamic> UpdateRuleAsync(long ruleId, IDictionary<string, string> nameMap, IDictionary<string, string> descriptionMap, string type, IDictionary<string, object> typeSettingsProperties, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
