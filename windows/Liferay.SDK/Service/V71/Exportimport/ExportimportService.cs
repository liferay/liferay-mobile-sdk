...
namespace Liferay.SDK.Service.V71.Exportimport
{
	public class ExportimportService : ServiceBase
	{
		...
		public async Task<dynamic> ExportLayoutsAsFileAsync(long userId, long groupId, bool privateLayout, IDictionary<string, object> parameterMap)
		{
			var _parameters = new JsonObject();
		...
		public async Task ImportLayoutsAsync(long userId, long groupId, bool privateLayout, IDictionary<string, object> parameterMap, Stream file)
		{
			var _parameters = new JsonObject();
