...
namespace Liferay.SDK.Service.V73.User
{
	public class UserService : ServiceBase
	{
		...
		public async Task<dynamic> AddUserAsync(long companyId, bool autoPassword, string password1, string password2, bool autoScreenName, string screenName, string emailAddress, string locale, string firstName, string middleName, string lastName, long prefixId, long suffixId, bool male, int birthdayMonth, int birthdayDay, int birthdayYear, string jobTitle, IEnumerable<long> groupIds, IEnumerable<long> organizationIds, IEnumerable<long> roleIds, IEnumerable<long> userGroupIds, bool sendEmail, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> UpdateUserAsync(long userId, string oldPassword, string newPassword1, string newPassword2, bool passwordReset, string reminderQueryQuestion, string reminderQueryAnswer, string screenName, string emailAddress, bool hasPortrait, byte[] portraitBytes, string languageId, string timeZoneId, string greeting, string comments, string firstName, string middleName, string lastName, long prefixId, long suffixId, bool male, int birthdayMonth, int birthdayDay, int birthdayYear, string smsSn, string facebookSn, string jabberSn, string skypeSn, string twitterSn, string jobTitle, IEnumerable<long> groupIds, IEnumerable<long> organizationIds, IEnumerable<long> roleIds, IEnumerable<object> userGroupRoles, IEnumerable<long> userGroupIds, IEnumerable<object> addresses, IEnumerable<object> emailAddresses, IEnumerable<object> phones, IEnumerable<object> websites, IEnumerable<object> announcementsDelivers, JsonObjectWrapper serviceContext)
		{
			...
			_parameters.Add("screenName", screenName);
			_parameters.Add("emailAddress", emailAddress);
			_parameters.Add("hasPortrait", hasPortrait);
		...
		public async Task<dynamic> UpdateUserAsync(long userId, string oldPassword, string newPassword1, string newPassword2, bool passwordReset, string reminderQueryQuestion, string reminderQueryAnswer, string screenName, string emailAddress, long facebookId, string openId, bool hasPortrait, byte[] portraitBytes, string languageId, string timeZoneId, string greeting, string comments, string firstName, string middleName, string lastName, long prefixId, long suffixId, bool male, int birthdayMonth, int birthdayDay, int birthdayYear, string smsSn, string facebookSn, string jabberSn, string skypeSn, string twitterSn, string jobTitle, IEnumerable<long> groupIds, IEnumerable<long> organizationIds, IEnumerable<long> roleIds, IEnumerable<object> userGroupRoles, IEnumerable<long> userGroupIds, IEnumerable<object> addresses, IEnumerable<object> emailAddresses, IEnumerable<object> phones, IEnumerable<object> websites, IEnumerable<object> announcementsDelivers, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> UpdateUserAsync(long userId, string oldPassword, string newPassword1, string newPassword2, bool passwordReset, string reminderQueryQuestion, string reminderQueryAnswer, string screenName, string emailAddress, string languageId, string timeZoneId, string greeting, string comments, string firstName, string middleName, string lastName, long prefixId, long suffixId, bool male, int birthdayMonth, int birthdayDay, int birthdayYear, string smsSn, string facebookSn, string jabberSn, string skypeSn, string twitterSn, string jobTitle, IEnumerable<long> groupIds, IEnumerable<long> organizationIds, IEnumerable<long> roleIds, IEnumerable<object> userGroupRoles, IEnumerable<long> userGroupIds, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetGroupUsersAsync(long groupId, int status, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetGroupUsersAsync(long groupId, int status, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetOrganizationUsersAsync(long organizationId, int status, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetOrganizationUsersAsync(long organizationId, int status, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> UpdateIncompleteUserAsync(long companyId, bool autoPassword, string password1, string password2, bool autoScreenName, string screenName, string emailAddress, string locale, string firstName, string middleName, string lastName, long prefixId, long suffixId, bool male, int birthdayMonth, int birthdayDay, int birthdayYear, string jobTitle, bool updateUserInformation, bool sendEmail, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
