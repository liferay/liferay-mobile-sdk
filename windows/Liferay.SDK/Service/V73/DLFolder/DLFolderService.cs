...
namespace Liferay.SDK.Service.V73.DLFolder
{
	public class DLFolderService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> GetFoldersAndFileEntriesAndFileShortcutsAsync(long groupId, long folderId, int status, bool includeMountFolders, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetFoldersAndFileEntriesAndFileShortcutsAsync(long groupId, long folderId, int status, IEnumerable<string> mimeTypes, bool includeMountFolders, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetFoldersAndFileEntriesAndFileShortcutsAsync(long groupId, long folderId, IEnumerable<string> mimeTypes, bool includeMountFolders, int status, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetFoldersAndFileEntriesAndFileShortcutsAsync(long groupId, long folderId, IEnumerable<string> mimeTypes, long fileEntryTypeId, bool includeMountFolders, int status, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetFoldersAndFileEntriesAndFileShortcutsAsync(long groupId, long folderId, bool includeMountFolders, int status, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetFileEntriesAndFileShortcutsCountAsync(long groupId, long folderId, IEnumerable<string> mimeTypes, int status)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetFoldersAsync(long groupId, long parentFolderId, int status, bool includeMountfolders, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetFoldersAsync(long groupId, long parentFolderId, bool includeMountfolders, int status, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetFoldersAsync(long groupId, long parentFolderId, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetFoldersAndFileEntriesAndFileShortcutsCountAsync(long groupId, long folderId, IEnumerable<string> mimeTypes, bool includeMountFolders, int status)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetFoldersAndFileEntriesAndFileShortcutsCountAsync(long groupId, long folderId, IEnumerable<string> mimeTypes, long fileEntryTypeId, bool includeMountFolders, int status)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetFoldersCountAsync(long groupId, long parentFolderId, bool includeMountfolders, int status)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetMountFoldersAsync(long groupId, long parentFolderId, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
