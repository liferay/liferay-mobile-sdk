...
namespace Liferay.SDK.Service.V73.DLFileEntry
{
	public class DLFileEntryService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> GetFileEntriesAsync(long groupId, long folderId, long fileEntryTypeId, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetFileEntriesAsync(long groupId, long folderId, IEnumerable<string> mimeTypes, int status, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetFileEntriesAsync(long groupId, long folderId, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetFileEntriesAsync(long groupId, long folderId, IEnumerable<string> mimeTypes, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetFileEntriesAsync(long groupId, long folderId, int status, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetFileEntriesCountAsync(long groupId, long folderId, IEnumerable<string> mimeTypes, int status)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetGroupFileEntriesAsync(long groupId, long userId, long repositoryId, long rootFolderId, IEnumerable<string> mimeTypes, int status, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
