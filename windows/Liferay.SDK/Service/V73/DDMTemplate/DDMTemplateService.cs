...
namespace Liferay.SDK.Service.V73.DDMTemplate
{
	public class DDMTemplateService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> GetTemplatesAsync(long companyId, IEnumerable<long> groupIds, IEnumerable<long> classNameIds, IEnumerable<long> classPKs, long resourceClassNameId, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetTemplatesCountAsync(long companyId, IEnumerable<long> groupIds, IEnumerable<long> classNameIds, IEnumerable<long> classPKs, long resourceClassNameId)
		{
			var _parameters = new JsonObject();
			...
			var _command = new JsonObject()
			{
				{ "/ddm.ddmtemplate/get-templates-count", _parameters }
			};
