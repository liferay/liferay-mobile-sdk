...
namespace Liferay.SDK.Service.V73.WikiPage
{
	public class WikiPageService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> GetPagesAsync(long groupId, long nodeId, bool head, int status, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetPagesAsync(long groupId, long nodeId, bool head, long userId, bool includeOwner, int status, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
