...
namespace Liferay.SDK.Service.V73.LayoutSetPrototype
{
	public class LayoutSetPrototypeService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> SearchAsync(long companyId, bool active, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
