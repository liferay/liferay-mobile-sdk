...
namespace Liferay.SDK.Service.V73.Role
{
	public class RoleService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> SearchAsync(long companyId, string keywords, IEnumerable<int> types, IDictionary<string, object> _params, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
