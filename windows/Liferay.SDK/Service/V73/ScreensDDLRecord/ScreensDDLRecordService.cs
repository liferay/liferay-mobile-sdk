...
namespace Liferay.SDK.Service.V73.ScreensDDLRecord
{
	public class ScreensDDLRecordService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> GetDdlRecordsAsync(long ddlRecordSetId, string locale, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetDdlRecordsAsync(long ddlRecordSetId, long userId, string locale, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
