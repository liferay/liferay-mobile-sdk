...
namespace Liferay.SDK.Service.V73.MDRAction
{
	public class MDRActionService : ServiceBase
	{
		...
		public async Task<dynamic> AddActionAsync(long ruleGroupInstanceId, IDictionary<string, string> nameMap, IDictionary<string, string> descriptionMap, string type, IDictionary<string, object> typeSettingsUnicodeProperties, JsonObjectWrapper serviceContext)
		{
		...
		public async Task<dynamic> UpdateActionAsync(long actionId, IDictionary<string, string> nameMap, IDictionary<string, string> descriptionMap, string type, IDictionary<string, object> typeSettingsUnicodeProperties, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
