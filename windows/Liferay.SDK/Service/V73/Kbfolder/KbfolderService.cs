...
namespace Liferay.SDK.Service.V73.Kbfolder
{
	public class KbfolderService : ServiceBase
	{
		...
		public async Task<dynamic> FetchFirstChildKbFolderAsync(long groupId, long kbFolderId, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
