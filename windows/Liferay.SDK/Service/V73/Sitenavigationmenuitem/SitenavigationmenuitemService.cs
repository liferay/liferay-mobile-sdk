...
namespace Liferay.SDK.Service.V73.Sitenavigationmenuitem
{
	public class SitenavigationmenuitemService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> GetSiteNavigationMenuItemsAsync(long siteNavigationMenuId, long parentSiteNavigationMenuItemId)
		{
			var _parameters = new JsonObject();
