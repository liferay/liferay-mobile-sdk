...
namespace Liferay.SDK.Service.V73.Layoutpagetemplateentry
{
	public class LayoutpagetemplateentryService : ServiceBase
	{
		...
		public async Task<dynamic> AddLayoutPageTemplateEntryAsync(long groupId, long layoutPageTemplateCollectionId, string name, int type, long masterLayoutPlid, int status, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> AddLayoutPageTemplateEntryAsync(long groupId, long layoutPageTemplateCollectionId, string name, int status, long classNameId, long classTypeId, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> AddLayoutPageTemplateEntryAsync(long groupId, long layoutPageTemplateCollectionId, long classNameId, long classTypeId, string name, long masterLayoutPlid, int status, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> AddLayoutPageTemplateEntryAsync(long groupId, long layoutPageTemplateCollectionId, long classNameId, long classTypeId, string name, int status, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> CopyLayoutPageTemplateEntryAsync(long groupId, long layoutPageTemplateCollectionId, long layoutPageTemplateEntryId, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
			...
			var _command = new JsonObject()
			{
				{ "/layout.layoutpagetemplateentry/copy-layout-page-template-entry", _parameters }
			};
		...
		public async Task<dynamic> FetchDefaultLayoutPageTemplateEntryAsync(long groupId, int type, int status)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetLayoutPageTemplateEntriesCountAsync(long groupId, long layoutPageTemplateCollectionId, string name, int status)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetLayoutPageTemplateEntriesCountAsync(long groupId, long layoutPageTemplateCollectionId, string name)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetLayoutPageTemplateEntriesCountAsync(long groupId, long layoutPageTemplateCollectionId, int status)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetLayoutPageTemplateEntriesCountAsync(long groupId, long layoutPageTemplateCollectionId)
		{
			var _parameters = new JsonObject();
