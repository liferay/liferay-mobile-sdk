...
namespace Liferay.SDK.Service.V73.TrashEntry
{
	public class TrashEntryService : ServiceBase
	{
		...
		public async Task<dynamic> GetEntriesAsync(long groupId, string className, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> GetEntriesAsync(long groupId, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
