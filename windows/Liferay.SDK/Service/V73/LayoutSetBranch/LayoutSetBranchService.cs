...
namespace Liferay.SDK.Service.V73.LayoutSetBranch
{
	public class LayoutSetBranchService : ServiceBase
	{
		...
		public async Task DeleteLayoutSetBranchAsync(long currentLayoutPlid, long layoutSetBranchId)
		{
			var _parameters = new JsonObject();

			_parameters.Add("currentLayoutPlid", currentLayoutPlid);
			_parameters.Add("layoutSetBranchId", layoutSetBranchId);
