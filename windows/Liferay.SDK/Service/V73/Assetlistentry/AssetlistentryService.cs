...
namespace Liferay.SDK.Service.V73.Assetlistentry
{
	public class AssetlistentryService : ServiceBase
	{
		...
		public async Task<IEnumerable<dynamic>> GetAssetListEntriesAsync(IEnumerable<long> groupIds, string assetEntrySubtype, string assetEntryType, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();

			_parameters.Add("groupIds", groupIds);
			_parameters.Add("assetEntrySubtype", assetEntrySubtype);
			_parameters.Add("assetEntryType", assetEntryType);
		...
		public async Task<IEnumerable<dynamic>> GetAssetListEntriesAsync(IEnumerable<long> groupIds, string title, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetAssetListEntriesAsync(IEnumerable<long> groupIds, string title, string assetEntrySubtype, string assetEntryType, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetAssetListEntriesAsync(IEnumerable<long> groupIds, IEnumerable<string> assetEntryTypes, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();

			_parameters.Add("groupIds", groupIds);
			_parameters.Add("assetEntryTypes", assetEntryTypes);
			_parameters.Add("start", start);
			_parameters.Add("end", end);
			this.MangleWrapper(_parameters, "orderByComparator", "$languageUtil.getJSONWrapperClassName($parameter.type)", orderByComparator);
		...
		public async Task<IEnumerable<dynamic>> GetAssetListEntriesAsync(IEnumerable<long> groupIds, string title, IEnumerable<string> assetEntryTypes, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetAssetListEntriesAsync(IEnumerable<long> groupIds, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetAssetListEntriesCountAsync(IEnumerable<long> groupIds)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetAssetListEntriesCountAsync(IEnumerable<long> groupIds, string title)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetAssetListEntriesCountAsync(IEnumerable<long> groupIds, string assetEntrySubtype, string assetEntryType)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetAssetListEntriesCountAsync(IEnumerable<long> groupIds, string title, string assetEntrySubtype, string assetEntryType)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetAssetListEntriesCountAsync(IEnumerable<long> groupIds, string title, IEnumerable<string> assetEntryTypes)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetAssetListEntriesCountAsync(IEnumerable<long> groupIds, IEnumerable<string> assetEntryTypes)
		{
			var _parameters = new JsonObject();
