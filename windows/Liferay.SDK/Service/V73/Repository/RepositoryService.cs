...
namespace Liferay.SDK.Service.V73.Repository
{
	public class RepositoryService : ServiceBase
	{
		...
		public async Task<dynamic> AddRepositoryAsync(long groupId, long classNameId, long parentFolderId, string name, string description, string portletId, IDictionary<string, object> typeSettingsUnicodeProperties, JsonObjectWrapper serviceContext)
		{
		...
		public async Task<dynamic> GetRepositoryAsync(long groupId, string portletId)
		{
			var _parameters = new JsonObject();
