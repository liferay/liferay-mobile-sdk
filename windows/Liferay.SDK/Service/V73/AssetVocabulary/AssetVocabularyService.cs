...
namespace Liferay.SDK.Service.V73.AssetVocabulary
{
	public class AssetVocabularyService : ServiceBase
	{
		...
		public async Task<dynamic> AddVocabularyAsync(long groupId, string title, IDictionary<string, string> titleMap, IDictionary<string, string> descriptionMap, string settings, int visibilityType, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
			...
			_parameters.Add("visibilityType", visibilityType);
		...
		public async Task<dynamic> AddVocabularyAsync(long groupId, string name, string title, IDictionary<string, string> titleMap, IDictionary<string, string> descriptionMap, string settings, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetGroupVocabulariesAsync(long groupId, string name, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetGroupVocabulariesAsync(IEnumerable<long> groupIds, IEnumerable<int> visibilityTypes)
		{
			var _parameters = new JsonObject();

			_parameters.Add("groupIds", groupIds);
			_parameters.Add("visibilityTypes", visibilityTypes);
		...
		public async Task<IEnumerable<dynamic>> GetGroupVocabulariesAsync(long groupId, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetGroupVocabulariesAsync(long groupId, bool createDefaultVocabulary, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetGroupVocabulariesAsync(long groupId, int visibilityType)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> UpdateVocabularyAsync(long vocabularyId, IDictionary<string, string> titleMap, IDictionary<string, string> descriptionMap, string settings)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> UpdateVocabularyAsync(long vocabularyId, IDictionary<string, string> titleMap, IDictionary<string, string> descriptionMap, string settings, int visibilityType)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> UpdateVocabularyAsync(long vocabularyId, string name, string title, IDictionary<string, string> titleMap, IDictionary<string, string> descriptionMap, string settings, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> GetGroupVocabulariesDisplayAsync(long groupId, string name, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> GetGroupVocabulariesDisplayAsync(long groupId, string name, int start, int end, bool addDefaultVocabulary, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
