...
namespace Liferay.SDK.Service.V73.Company
{
	public class CompanyService : ServiceBase
	{
		...
		public async Task UpdatePreferencesAsync(long companyId, IDictionary<string, object> unicodeProperties)
		{
			var _parameters = new JsonObject();

			_parameters.Add("companyId", companyId);
			_parameters.Add("unicodeProperties", unicodeProperties);
