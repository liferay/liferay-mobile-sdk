...
namespace Liferay.SDK.Service.V73.Layout
{
	public class LayoutService : ServiceBase
	{
		...
		public async Task<dynamic> FetchLayoutAsync(long groupId, bool privateLayout, long layoutId)
		{
			...
			{
				{ "/layout/fetch-layout", _parameters }
			};
		...
		public async Task<IEnumerable<dynamic>> GetLayoutsAsync(long groupId, bool privateLayout, string type)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetLayoutsAsync(long groupId, bool privateLayout, string type, int start, int end)
		{
			var _parameters = new JsonObject();
		...
		public async Task<IEnumerable<dynamic>> GetLayoutsAsync(long groupId, bool privateLayout, string keywords, IEnumerable<string> types, int start, int end, JsonObjectWrapper orderByComparator)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> AddLayoutAsync(long groupId, bool privateLayout, long parentLayoutId, long classNameId, long classPK, IDictionary<string, string> localeNamesMap, IDictionary<string, string> localeTitlesMap, IDictionary<string, string> descriptionMap, IDictionary<string, string> keywordsMap, IDictionary<string, string> robotsMap, string type, string typeSettings, bool hidden, bool system, IDictionary<string, string> friendlyURLMap, long masterLayoutPlid, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
			...
			_parameters.Add("system", system);
			_parameters.Add("friendlyURLMap", friendlyURLMap);
			_parameters.Add("masterLayoutPlid", masterLayoutPlid);
			this.MangleWrapper(_parameters, "serviceContext", "$languageUtil.getJSONWrapperClassName($parameter.type)", serviceContext);
		...
		public async Task<dynamic> AddLayoutAsync(long groupId, bool privateLayout, long parentLayoutId, long classNameId, long classPK, IDictionary<string, string> localeNamesMap, IDictionary<string, string> localeTitlesMap, IDictionary<string, string> descriptionMap, IDictionary<string, string> keywordsMap, IDictionary<string, string> robotsMap, string type, string typeSettings, bool hidden, bool system, long masterLayoutPlid, IDictionary<string, string> friendlyURLMap, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> AddLayoutAsync(long groupId, bool privateLayout, long parentLayoutId, IDictionary<string, string> localeNamesMap, IDictionary<string, string> localeTitlesMap, IDictionary<string, string> descriptionMap, IDictionary<string, string> keywordsMap, IDictionary<string, string> robotsMap, string type, string typeSettings, bool hidden, long masterLayoutPlid, IDictionary<string, string> friendlyURLMap, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> AddLayoutAsync(long groupId, bool privateLayout, long parentLayoutId, IDictionary<string, string> localeNamesMap, IDictionary<string, string> localeTitlesMap, IDictionary<string, string> descriptionMap, IDictionary<string, string> keywordsMap, IDictionary<string, string> robotsMap, string type, string typeSettings, bool hidden, IDictionary<string, string> friendlyURLMap, long masterLayoutPlid, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> UpdateLayoutAsync(long groupId, bool privateLayout, long layoutId, long parentLayoutId, IDictionary<string, string> localeNamesMap, IDictionary<string, string> localeTitlesMap, IDictionary<string, string> descriptionMap, IDictionary<string, string> keywordsMap, IDictionary<string, string> robotsMap, string type, bool hidden, IDictionary<string, string> friendlyURLMap, bool hasIconImage, byte[] iconBytes, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
			...
			_parameters.Add("hidden", hidden);
			_parameters.Add("friendlyURLMap", friendlyURLMap);
			_parameters.Add("hasIconImage", hasIconImage);
		...
		public async Task<dynamic> UpdateLayoutAsync(long groupId, bool privateLayout, long layoutId, long parentLayoutId, IDictionary<string, string> localeNamesMap, IDictionary<string, string> localeTitlesMap, IDictionary<string, string> descriptionMap, IDictionary<string, string> keywordsMap, IDictionary<string, string> robotsMap, string type, bool hidden, IDictionary<string, string> friendlyURLMap, bool hasIconImage, byte[] iconBytes, long masterLayoutPlid, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetLayoutsCountAsync(long groupId, bool privateLayout, string type)
		{
			var _parameters = new JsonObject();
		...
		public async Task<long> GetLayoutsCountAsync(long groupId, bool privateLayout, string keywords, IEnumerable<string> types)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> UpdateTypeAsync(long plid, string type)
		{
			var _parameters = new JsonObject();
			...
			var _command = new JsonObject()
			{
				{ "/layout/update-type", _parameters }
			};
