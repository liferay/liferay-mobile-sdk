...
namespace Liferay.SDK.Service.V73.LayoutSet
{
	public class LayoutSetService : ServiceBase
	{
		...
		public async Task<dynamic> UpdateVirtualHostAsync(long groupId, bool privateLayout, string virtualHostname)
		{
			var _parameters = new JsonObject();

			_parameters.Add("groupId", groupId);
			_parameters.Add("privateLayout", privateLayout);
			_parameters.Add("virtualHostname", virtualHostname);
		...
		public async Task UpdateLogoAsync(long groupId, bool privateLayout, bool hasLogo, Stream file)
		{
			var _parameters = new JsonObject();
		...
		public async Task UpdateLogoAsync(long groupId, bool privateLayout, bool hasLogo, byte[] bytes)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> UpdateVirtualHostsAsync(long groupId, bool privateLayout, IDictionary<string, string> virtualHostnames)
		{
			var _parameters = new JsonObject();

			_parameters.Add("groupId", groupId);
			_parameters.Add("privateLayout", privateLayout);
			_parameters.Add("virtualHostnames", virtualHostnames);

			var _command = new JsonObject()
			{
				{ "/layoutset/update-virtual-hosts", _parameters }
			};
