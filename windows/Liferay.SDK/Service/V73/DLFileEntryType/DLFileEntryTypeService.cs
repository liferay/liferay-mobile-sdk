...
namespace Liferay.SDK.Service.V73.DLFileEntryType
{
	public class DLFileEntryTypeService : ServiceBase
	{
		...
		public async Task<dynamic> UpdateFileEntryTypeAsync(long fileEntryTypeId, IDictionary<string, string> nameMap, IDictionary<string, string> descriptionMap)
		{
			var _parameters = new JsonObject();
		...
		public async Task<dynamic> AddFileEntryTypeAsync(long groupId, long dataDefinitionId, string fileEntryTypeKey, IDictionary<string, string> nameMap, IDictionary<string, string> descriptionMap, JsonObjectWrapper serviceContext)
		{
			var _parameters = new JsonObject();

			_parameters.Add("groupId", groupId);
			_parameters.Add("dataDefinitionId", dataDefinitionId);
