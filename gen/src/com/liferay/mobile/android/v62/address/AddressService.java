...
public class AddressService extends BaseService {
	public AddressService(ServiceContext context) {
		super(context);
	}

	public AddressService(ServiceContext context, AsyncTaskCallback callback) {
		super(context, callback);
	}

	public AddressService(ServiceContext context, boolean batch) {
		super(context, batch);
	}
