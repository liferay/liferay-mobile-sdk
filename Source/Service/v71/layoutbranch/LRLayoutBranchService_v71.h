 ...
 */
@interface LRLayoutBranchService_v71 : LRBaseService
...
- (void)deleteLayoutBranchWithLayoutBranchId:(long long)layoutBranchId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
