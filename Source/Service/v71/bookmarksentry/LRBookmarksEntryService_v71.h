 ...
 */
@interface LRBookmarksEntryService_v71 : LRBaseService
...
- (void)subscribeEntryWithEntryId:(long long)entryId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
- (void)unsubscribeEntryWithEntryId:(long long)entryId error:(NSError **)error CONVERT_ERROR_TO_THROWS;
